...
.field private static final FEATURE_AOD:Ljava/lang/String; = "com.motorola.software.alwaysondisplay"
...
.method public constructor <init>()V
    ...
    .line 303
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasMenuBar:Z

    .line 304
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mNeedsShowMenuBar:Z

    .line 306
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTaskButtonBehavior:I

    .line 307
    iput v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTSBDisableFlags:I
    ...
    .line 385
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopTSBWhenShowingSearchPenal:Z
    ...
    .line 524
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStartShowSearchPanel:Z
...
.method static synthetic access$902(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/IBinder;)Landroid/os/IBinder;
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindowManager;
    .param p1, "x1"    # Landroid/os/IBinder;
...
.method private canRunGlimpseProxyService()Z
    ...
    const-string v2, "com.motorola.software.alwaysondisplay"
    ...
    const-string v3, "AOD feature not enabled!"
...
.method private isDisabledTSBKey(I)Z
    ...
    iget v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTSBDisableFlags:I
...
.method private notifyCameraInstantOn(Landroid/view/KeyEvent;)V
    ...
    .line 4506
    const-string v1, "motorola.intent.extra.CALLER"
...
.method private updateSystemUiVisibilityLw()I
    ...
    new-instance v9, Lcom/android/internal/policy/impl/PhoneWindowManager$28;

    invoke-direct {v9, p0, v6, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager$28;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;IZ)V
...
.method public applyPostLayoutPolicyLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {v1, v6, v7}, Landroid/app/admin/DevicePolicyManager;->forceActivityAboveKeyguard(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 4047
    invoke-virtual {v1}, Landroid/app/admin/DevicePolicyManager;->isAovBypassKeyguardGoogleNowEnabled()Z
    ...
    .line 4051
    iput-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mNeedToClearWindowFlag:Z
    ...
    .line 4057
    iput-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mNeedToClearWindowFlag:Z
...
.method handleVolumeKey(II)V
    ...
    invoke-interface {v0, v2, p1, v3, v4}, Landroid/media/IAudioService;->adjustSuggestedStreamVolume(IIILjava/lang/String;)V
    :try_end_2
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidConfigurationChange:Z
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    sget-boolean v3, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_KPI:Z

    if-eqz v3, :cond_0

    .line 2328
    const-string v3, "KPI-SCR-2"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "PhoneWindowManager.interceptKeyBeforeQueueing start:  keyCode="
    ...
    const-string v5, "gsm.stk.event.useractivity"
    ...
    const-string v3, "android.intent.action.stk.user_activity"

    invoke-direct {v12, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2342
    .local v12, "StkIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 2350
    .end local v12    # "StkIntent":Landroid/content/Intent;
    :cond_1
    move-object/from16 v0, p0
    ...
    iget v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTSBDisableFlags:I
    ...
    iget-object v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShowSearchPanel:Ljava/lang/Runnable;
    ...
    iget-object v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHideSearchPanel:Ljava/lang/Runnable;
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStartShowSearchPanel:Z
    ...
    .line 2437
    :cond_f
    sget v3, Lcom/motorola/kpi/Kpi6paTop;->DEBUG_6PA_KPI:I
    ...
    const-string v6, " Launch Home from hot key"
    ...
    .line 2444
    const-string v3, "KPI-3"

    const-string v5, "PhoneWindowManager.interceptKeyTi launchHomeFromHotKey start"
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopTSBWhenShowingSearchPenal:Z
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStopTSBWhenShowingSearchPenal:Z
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStartShowSearchPanel:Z
    ...
    .line 2509
    .end local v36    # "showSearchHoldoff":I
    :cond_1e
    invoke-virtual/range {p2 .. p2}, Landroid/view/KeyEvent;->getFlags()I
    ...
    invoke-virtual {v14, v3}, Landroid/media/AudioManager;->getStreamVolume(I)I
    ...
    const-string v5, "unmute the music when volume key pressed"
    ...
    invoke-virtual {v14, v3, v5}, Landroid/media/AudioManager;->setStreamMute(IZ)V
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTaskKeyLongPressed:Z
    ...
    iget v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTaskButtonBehavior:I
    ...
    const-string v5, "Ignoring TASK; event canceled."
    ...
    const-string v5, "Invalid value for task button behavior observed!"
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mTaskKeyLongPressed:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    :goto_4
    sget-boolean v21, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_KPI:Z

    if-eqz v21, :cond_3

    .line 4563
    const-string v21, "KPI-SCR-2"

    new-instance v22, Ljava/lang/StringBuilder;

    invoke-direct/range {v22 .. v22}, Ljava/lang/StringBuilder;-><init>()V

    const-string v23, "PhoneWindowManager.interceptKeyBeforeQueueing start:  keyCode="
    ...
    .line 4952
    const-string v21, "KPI-SCR-3"

    new-instance v22, Ljava/lang/StringBuilder;

    invoke-direct/range {v22 .. v22}, Ljava/lang/StringBuilder;-><init>()V

    const-string v23, "PhoneWindowManager.interceptKeyBeforeQueueing complete: result="
    ...
    const-string v21, "com.motorola.bodyguard.ENTER_ALERT_MODE"
    ...
    const-string v21, "key_chord_type"
    ...
    invoke-virtual {v5, v0, v1}, Landroid/media/AudioManager;->setStreamMute(IZ)V
    ...
    invoke-virtual {v5, v0, v1, v2}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
    ...
    .line 4767
    .local v12, "isGlimpseHandlePowerkey":Z
    ...
    .line 4764
    .end local v11    # "hungUp":Z
    .end local v12    # "isGlimpseHandlePowerkey":Z
    .end local v20    # "telephonyService":Lcom/android/internal/telephony/ITelephony;
    :cond_23
    const/16 v21, 0x0
    ...
    .line 4781
    .restart local v12    # "isGlimpseHandlePowerkey":Z
    :cond_24
    const/16 v21, 0x0
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->waitForKeyguard(Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    ...
    invoke-interface/range {v21 .. v21}, Landroid/app/IActivityManager;->resumeAppSwitches()V
    :try_end_7
    ...
    const-string v22, "Couldn\'t inform am about resume app switch on camera key"
    ...
    const-string v22, "Couldn\'t inform am about wakeup on camera key"
...
.method public layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    .line 3598
    .restart local v14    # "hasMenuBar":Z
    :cond_8
    const/4 v15, 0x0
...
.method public notifyLidSwitchChanged(JZ)V
    ...
    .line 4300
    iget-boolean v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidConfigurationChange:Z
    ...
    :cond_3
    :goto_3
    const-string v3, "hw.folio.closed"
    ...
    const-string v2, "com.motorola.folio.STATE_CHANGE"
    ...
    .line 4316
    const-string v2, "com.motorola.folio"
...
.method public notifyShowSearchPanel()V
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShowSearchPanel:Ljava/lang/Runnable;
...
.method public prepareAddWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)I
    ...
    const-string v2, "Keyguard is still Alive!"
    ...
    const-string v1, "Keyguard is not alive, replace it!"
...
.method public updateSettings()V
    ...
    invoke-static {v5, v11, v2}, Lcom/motorola/android/provider/MotorolaSettings;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v0

    .line 1329
    .local v0, "behaviorSetting":I
    const-string v11, "tsb_disable_flags"
    ...
    invoke-static {v5, v12, v13, v14}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v5, v12, v13, v14}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
