...
.method public makeNewWindowManager()Landroid/view/WindowManagerPolicy;
    ...
    .prologue
    .line 76
    const-string v1, "ro.partial.display"
    ...
    .line 77
    .local v0, "partialDisplayEnabled":Z
    if-eqz v0, :cond_0

    .line 78
    new-instance v1, Lcom/android/internal/policy/impl/PhoneWindowManagerWithPartialDisplay;

    invoke-direct {v1}, Lcom/android/internal/policy/impl/PhoneWindowManagerWithPartialDisplay;-><init>()V
    ...
    :cond_0
    new-instance v1, Lcom/android/internal/policy/impl/PhoneWindowManager;

    invoke-direct {v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;-><init>()V
