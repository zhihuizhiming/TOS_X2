...
.method private displayedActivity(Landroid/content/ComponentName;Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;J)V
    ...
    .prologue
    .line 538
    iget-object v9, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->proc:Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;

    iget-wide v9, v9, Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;->coldTime:J

    iget-wide v11, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->warmTime:J
    ...
    .local v1, "coldProc":Z
    :goto_0
    iget-wide v9, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->coldTime:J
    ...
    iget-wide v2, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->coldTime:J
    ...
    .line 542
    .local v5, "time":J
    iget-wide v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->firstActTime:J
    ...
    .line 545
    .local v7, "totTime":J
    iput-wide v5, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastLaunchTime:J

    .line 546
    iput-wide v7, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastTotalTime:J

    .line 547
    iget-boolean v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastColdProc:Z
    ...
    :goto_4
    iput-boolean v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastColdProc:Z

    .line 548
    iget-boolean v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastColdAct:Z
    ...
    :goto_5
    iput-boolean v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastColdAct:Z

    .line 550
    invoke-direct {p0, p1, v5, v6, v1}, Lcom/motorola/kpi/LaunchCheckinHandler;->addData(Landroid/content/ComponentName;JZ)V
    ...
    iget-object v9, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->name:Ljava/lang/String;
    ...
    .line 540
    .restart local v0    # "coldAct":Z
    :cond_4
    iget-wide v2, p2, Lcom/motorola/kpi/LaunchCheckinHandler$ActLaunch;->warmTime:J

    goto :goto_2

    .line 542
    .restart local v2    # "launchTime":J
    .restart local v5    # "time":J
    :cond_5
    iget-wide v9, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->firstLaunchTime:J

    goto :goto_3

    .line 547
    .restart local v7    # "totTime":J
    :cond_6
    const/4 v9, 0x0
...
.method private printTotalTime()V
    ...
    .prologue
    .line 290
    iget-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastTotalTime:J
    ...
    iget-wide v3, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastLaunchTime:J
...
.method private reset()V
    ...
    .line 306
    iput-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastCallTime:J

    iput-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->firstActTime:J

    iput-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->firstLaunchTime:J

    .line 307
    iput-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastTotalTime:J

    iput-wide v1, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->lastLaunchTime:J
...
.method private saveStatsLocked(J)V
    ...
    const-string v11, "saveStats() error: "
...
.method private sendStatsPackage(JLjava/lang/String;Lcom/motorola/kpi/LaunchCheckinHandler$ComponentLaunchStats;)V
    ...
    invoke-virtual {v0, v1, p3}, Lcom/motorola/data/event/api/Event;->setValue(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/motorola/data/event/api/Event;->setValue(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/motorola/data/event/api/Event;->setValue(Ljava/lang/String;D)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/motorola/data/event/api/Event;->setValue(Ljava/lang/String;J)V
...
.method declared-synchronized displayed(Landroid/content/ComponentName;J)V
    ...
    check-cast v5, Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;

    .line 494
    .local v5, "pl":Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;
    if-eqz v5, :cond_3
    ...
    .line 496
    iget-object v6, v5, Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;->started:Ljava/util/Map;
    ...
    .line 525
    .local v3, "now":J
    invoke-direct {p0, v3, v4}, Lcom/motorola/kpi/LaunchCheckinHandler;->timeToSave(J)Z
    ...
    invoke-virtual {p0, v3, v4, v6}, Lcom/motorola/kpi/LaunchCheckinHandler;->saveStats(JZ)V
    :try_end_1
    ...
    .end local v3    # "now":J
    .end local v5    # "pl":Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;
    :cond_4
    :goto_2
    :try_start_2
    ...
    .restart local v5    # "pl":Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;
    :cond_5
    :try_start_3
    iget-object v6, v5, Lcom/motorola/kpi/LaunchCheckinHandler$ProcLaunch;->suspended:Ljava/util/Map;
...
.method declared-synchronized newApp(Landroid/content/ComponentName;J)V
    ...
    const-string v6, "newApp() exception: "
...
.method declared-synchronized newProc(Ljava/lang/String;J)V
    ...
    const-string v4, "newProc() exception: "
...
.method declared-synchronized start(Landroid/content/ComponentName;J)V
    ...
    const-string v6, "start() exception: "
...
.method declared-synchronized suspend(Landroid/content/ComponentName;J)V
    ...
    .line 450
    iget-wide v3, p0, Lcom/motorola/kpi/LaunchCheckinHandler;->firstLaunchTime:J
    ...
    const-string v5, "suspend() exception: "
