...
.field static final TRANSACTION_addListener:I = 0x3b
...
.field static final TRANSACTION_closeIccLogicalChannel:I = 0x40
...
.field static final TRANSACTION_doMobileDataRecovery:I = 0x44
...
.field static final TRANSACTION_getAllCellInfo:I = 0x32
...
.field static final TRANSACTION_getDataNetworkType:I = 0x2e

.field static final TRANSACTION_getDataState:I = 0x24

.field static final TRANSACTION_getDeviceId:I = 0x33

.field static final TRANSACTION_getIccPin1RetryCount:I = 0xf

.field static final TRANSACTION_getImsRegistrationState:I = 0x43

.field static final TRANSACTION_getLastError:I = 0x41
...
.field static final TRANSACTION_getUTCObject_MotoExt:I = 0x45

.field static final TRANSACTION_getVoiceMessageCount:I = 0x2c

.field static final TRANSACTION_getVoiceNetworkType:I = 0x2f
...
.field static final TRANSACTION_merge:I = 0x36

.field static final TRANSACTION_mute:I = 0x38

.field static final TRANSACTION_needsOtaServiceProvisioning:I = 0x2b

.field static final TRANSACTION_openIccLogicalChannel:I = 0x3f

.field static final TRANSACTION_playDtmfTone:I = 0x39

.field static final TRANSACTION_removeListener:I = 0x3c

.field static final TRANSACTION_sendOemRilRequestRaw:I = 0x26

.field static final TRANSACTION_sendOemRilRequestRawAsync:I = 0x27
...
.field static final TRANSACTION_shutdownRadio:I = 0x16

.field static final TRANSACTION_silenceRinger:I = 0x7

.field static final TRANSACTION_stopDtmfTone:I = 0x3a
...
.field static final TRANSACTION_swap:I = 0x37

.field static final TRANSACTION_toggleHold:I = 0x35

.field static final TRANSACTION_toggleRadioOnOff:I = 0x14

.field static final TRANSACTION_transmitIccBasicChannel:I = 0x3e

.field static final TRANSACTION_transmitIccLogicalChannel:I = 0x3d

.field static final TRANSACTION_transmitIccSimIO:I = 0x42
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 206
    .restart local v3    # "_arg1":Ljava/lang/String;
    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/ITelephony$Stub;->supplyPukReportResult(Ljava/lang/String;Ljava/lang/String;)[I
    ...
    .line 241
    invoke-virtual {p0}, Lcom/android/internal/telephony/ITelephony$Stub;->shutdownRadio()Z
    ...
    .line 341
    .local v12, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/NeighboringCellInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 347
    .end local v2    # "_arg0":Ljava/lang/String;
    .end local v12    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/NeighboringCellInfo;>;"
    :sswitch_22
    const-string v1, "com.android.internal.telephony.ITelephony"
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/IOemHookCallback$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/IOemHookCallback;

    move-result-object v3

    .line 403
    .local v3, "_arg1":Lcom/android/internal/telephony/IOemHookCallback;
    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/ITelephony$Stub;->sendOemRilRequestRawAsync([BLcom/android/internal/telephony/IOemHookCallback;)V
    ...
    .line 409
    .end local v2    # "_arg0":[B
    .end local v3    # "_arg1":Lcom/android/internal/telephony/IOemHookCallback;
    :sswitch_28
    const-string v1, "com.android.internal.telephony.ITelephony"
    ...
    .line 491
    .local v11, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 497
    .end local v11    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/CellInfo;>;"
    :sswitch_33
    const-string v1, "com.android.internal.telephony.ITelephony"
    ...
    .line 500
    .local v2, "_arg0":I
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/ITelephony$Stub;->getDeviceId(I)Ljava/lang/String;
    ...
    .local v2, "_arg0":Z
    :goto_19
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/ITelephony$Stub;->mute(Z)V
    ...
    .local v3, "_arg1":Z
    :goto_1a
    invoke-virtual {p0, v2, v3}, Lcom/android/internal/telephony/ITelephony$Stub;->playDtmfTone(CZ)V
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/ITelephonyListener$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/ITelephonyListener;

    move-result-object v2

    .line 567
    .local v2, "_arg0":Lcom/android/internal/telephony/ITelephonyListener;
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/ITelephony$Stub;->addListener(Lcom/android/internal/telephony/ITelephonyListener;)V
    ...
    .line 573
    .end local v2    # "_arg0":Lcom/android/internal/telephony/ITelephonyListener;
    :sswitch_3c
    const-string v1, "com.android.internal.telephony.ITelephony"
    ...
    .line 576
    .restart local v2    # "_arg0":Lcom/android/internal/telephony/ITelephonyListener;
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/ITelephony$Stub;->removeListener(Lcom/android/internal/telephony/ITelephonyListener;)V
    ...
    .line 673
    invoke-virtual {p0}, Lcom/android/internal/telephony/ITelephony$Stub;->getImsRegistrationState()Z
    ...
    .line 683
    .restart local v2    # "_arg0":I
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/ITelephony$Stub;->doMobileDataRecovery(I)V
    ...
    .line 690
    invoke-virtual {p0}, Lcom/android/internal/telephony/ITelephony$Stub;->getUTCObject_MotoExt()Ljava/util/List;
