...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface/range {v26 .. v27}, Lcom/android/internal/telephony/CommandsInterface;->getBasebandVersion(Landroid/os/Message;)V
    ...
    invoke-interface/range {v26 .. v27}, Lcom/android/internal/telephony/CommandsInterface;->getIMEI(Landroid/os/Message;)V
    ...
    invoke-interface/range {v26 .. v27}, Lcom/android/internal/telephony/CommandsInterface;->getIMEISV(Landroid/os/Message;)V
    ...
    invoke-interface/range {v26 .. v26}, Lcom/android/internal/telephony/CommandsInterface;->getLteOnCdmaMode()I
    ...
    invoke-interface/range {v26 .. v27}, Lcom/android/internal/telephony/CommandsInterface;->getDeviceIdentity(Landroid/os/Message;)V

    .line 1430
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/PhoneBase;->setLowCoverageConf()V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/PhoneBase;->getIccSerialNumber()Ljava/lang/String;

    move-result-object v13

    .line 1450
    .local v13, "iccidFromSIM":Ljava/lang/String;
    if-eqz v12, :cond_3
    ...
    .end local v13    # "iccidFromSIM":Ljava/lang/String;
    :sswitch_4
    move-object/from16 v0, p1
    ...
    const-string v28, "Baseband version: "
    ...
    .line 1471
    .local v21, "propArray":[Ljava/lang/String;
    ...
    .line 1473
    .local v20, "prop":Ljava/lang/String;
    const/4 v14, 0x1

    .line 1474
    .local v14, "isNewProp":Z
    if-eqz v20, :cond_4
    ...
    const-string v27, "Baseband version existed!"
    ...
    const-string v26, "ril.baseband.config.version"
    ...
    .line 1492
    .local v8, "configVersion":Ljava/lang/String;
    if-eqz v8, :cond_5
    ...
    const-string v28, "Setting baseband version: "
    ...
    .line 1477
    .end local v8    # "configVersion":Ljava/lang/String;
    ...
    .end local v5    # "arr$":[Ljava/lang/String;
    .end local v11    # "i$":I
    .end local v14    # "isNewProp":Z
    .end local v15    # "len$":I
    .end local v19    # "p":Ljava/lang/String;
    .end local v20    # "prop":Ljava/lang/String;
    .end local v21    # "propArray":[Ljava/lang/String;
    :sswitch_5
    move-object/from16 v0, p1
    ...
    const-string v27, "error parsing USSD"
    ...
    check-cast v26, Lcom/android/internal/telephony/gsm/GsmMmiCode;

    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isPendingUSSD()Z
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->onUssdFinishedError()V
    ...
    invoke-static/range {v26 .. v28}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    .line 1583
    .restart local v4    # "ar":Landroid/os/AsyncResult;
    const-class v26, Lcom/android/internal/telephony/uicc/IccVmNotSupportedException;

    iget-object v0, v4, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;

    move-object/from16 v27, v0

    invoke-virtual/range {v26 .. v27}, Ljava/lang/Class;->isInstance(Ljava/lang/Object;)Z
    ...
    check-cast v26, [Lcom/android/internal/telephony/CallForwardInfo;
    ...
    const-string v27, "Stop duplicate SET_NETWORK_SELECTION_AUTOMATIC to Ril "
    ...
    const-string v27, "Event EVENT_SS received"
    ...
    check-cast v26, Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    const-string v28, "Callforwarding is "
...
.method notifyPreciseCallStateChanged()V
    ...
    .line 470
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mCsLowCoverageConf:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/PhoneBase;->notifyCallStateChange(Z)V
...
.method public setRadioPower(ZZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/telephony/ServiceStateTracker;->setRadioPower(ZZ)V
...
.method public updateCurrentCarrierInProvider()Z
    ...
    .line 1739
    invoke-virtual {p0, v2, v1}, Lcom/android/internal/telephony/PhoneBase;->fillMvnoInfoToMap(Lcom/android/internal/telephony/uicc/IccRecords;Landroid/content/ContentValues;)V
