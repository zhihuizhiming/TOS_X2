...
.method private sendMultipartSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    iget-object v0, p1, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mAppInfo:Landroid/content/pm/PackageInfo;
...
.method protected getSmsTracker(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;Ljava/lang/String;)Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    .locals 7
...
.method protected getSmsTracker(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;ZLjava/lang/String;)Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    .locals 12
    .param p2, "sentIntent"    # Landroid/app/PendingIntent;
    .param p3, "deliveryIntent"    # Landroid/app/PendingIntent;
    .param p4, "format"    # Ljava/lang/String;
...
.method protected handleSendComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-static {v11, v0}, Lcom/android/internal/telephony/SmsApplication;->shouldWriteMessageForPackage(Ljava/lang/String;Landroid/content/Context;)Z

    move-result v4

    .line 368
    .local v4, "bAllowWriteMessage":Z
    move-object/from16 v0, p0
    ...
    .line 371
    .local v9, "filterListArray":[Ljava/lang/String;
    if-eqz v9, :cond_3
    ...
    .line 373
    .local v5, "destinationAddress":Ljava/lang/String;
    move-object/from16 v0, v16
    ...
    .line 376
    .local v3, "arrFilterInfo":[Ljava/lang/String;
    array-length v0, v3
    ...
    .line 357
    .end local v3    # "arrFilterInfo":[Ljava/lang/String;
    .end local v4    # "bAllowWriteMessage":Z
    .end local v5    # "destinationAddress":Ljava/lang/String;
    .end local v9    # "filterListArray":[Ljava/lang/String;
    .end local v10    # "i":I
    .end local v11    # "packageName":Ljava/lang/String;
    .end local v15    # "text":Ljava/lang/String;
    :cond_1
    const-string v17, "SMSDispatcher"
    ...
    .line 379
    .restart local v3    # "arrFilterInfo":[Ljava/lang/String;
    .restart local v4    # "bAllowWriteMessage":Z
    .restart local v5    # "destinationAddress":Ljava/lang/String;
    .restart local v9    # "filterListArray":[Ljava/lang/String;
    ...
    invoke-direct {v0, v5, v15, v11, v3}, Lcom/android/internal/telephony/SMSDispatcher;->needToFilter(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->writeSentMessage(Landroid/content/Context;)V
    ...
    .line 409
    .local v7, "extraIntent":Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/PhoneBase;->getSubscription()I
    ...
    invoke-virtual {v13, v0, v1, v7}, Landroid/app/PendingIntent;->send(Landroid/content/Context;ILandroid/content/Intent;)V
    :try_end_0
    .catch Landroid/app/PendingIntent$CanceledException; {:try_start_0 .. :try_end_0} :catch_1

    .line 478
    .end local v4    # "bAllowWriteMessage":Z
    .end local v7    # "extraIntent":Landroid/content/Intent;
    .end local v9    # "filterListArray":[Ljava/lang/String;
    .end local v11    # "packageName":Ljava/lang/String;
    :cond_8
    :goto_2
    ...
    invoke-static {v14, v0}, Lcom/android/internal/telephony/SMSDispatcher;->handleNotInService(ILandroid/app/PendingIntent;)V
    ...
    .line 463
    .local v8, "fillIn":Landroid/content/Intent;
    move-object/from16 v0, p1
    ...
    invoke-virtual {v0, v1, v6, v8}, Landroid/app/PendingIntent;->send(Landroid/content/Context;ILandroid/content/Intent;)V
    :try_end_1
    ...
    .line 475
    .end local v8    # "fillIn":Landroid/content/Intent;
    :catch_0
    move-exception v17
...
.method protected sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/String;)V
    ...
    iput v15, v11, Lcom/android/internal/telephony/SmsHeader$ConcatRef;->refNumber:I
    ...
    .line 699
    iget v1, v12, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->languageTable:I

    iput v1, v5, Lcom/android/internal/telephony/SmsHeader;->languageTable:I

    .line 700
    iget v1, v12, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->languageShiftTable:I
...
.method protected abstract sendTextMore(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)V
.end method
