...
.field private static final CONF_CS_LOW_COVERAGE_PATH:Ljava/lang/String; = "/etc/cslc.conf"

.field private static final CONF_PS_LOW_COVERAGE_PATH:Ljava/lang/String; = "/etc/pslc.conf"
...
.field protected static final EVENT_GET_IMS_MODE:I = 0x65
...
.field protected static final EVENT_RIL_CONNECTED:I = 0x64
...
.field protected static final EVENT_SET_IMS_MODE:I = 0x66

.field protected static final EVENT_SET_LOW_COVERAGE_CONF:I = 0x2a
...
.field private static final EVENT_UNSOL_OEM_HOOK_RAW:I = 0x29

.field protected static final EVENT_USSD:I = 0x7

.field public static final IMS_MODE_ENABLE_KEY:Ljava/lang/String; = "ims_mode_enable_key"
...
.field protected final mCallTypeChangeRegistrants:Landroid/os/RegistrantList;

.field public mCi:Lcom/android/internal/telephony/CommandsInterface;

.field private mConSetImsMode:I
...
.field private mRoamMode:Z

.field protected final mServiceStateRegistrants:Landroid/os/RegistrantList;

.field private mSetImsMode:Z

.field private mSetImsModeBak:Z

.field private mSetImsModeInProgress:Z
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    .line 228
    iput v6, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    .line 229
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsMode:Z

    .line 230
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeBak:Z

    .line 231
    iput v6, p0, Lcom/android/internal/telephony/PhoneBase;->mConSetImsMode:I

    .line 232
    iput-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->mRoamMode:Z

    .line 233
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeInProgress:Z
    ...
    .line 332
    iput-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->mCsLowCoverageConf:Ljava/lang/String;

    .line 333
    iput-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->mPsLowCoverageConf:Ljava/lang/String;

    .line 334
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mIsCsCoverageLow:Z

    .line 335
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mIsPsCoverageLow:Z

    .line 336
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mIsInCall:Z
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mCallTypeChangeRegistrants:Landroid/os/RegistrantList;
    ...
    .line 419
    const-string v1, "/etc/cslc.conf"

    invoke-static {v1}, Lcom/android/internal/telephony/PhoneBase;->file2String(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mCsLowCoverageConf:Ljava/lang/String;

    .line 420
    const-string v1, "/etc/pslc.conf"

    invoke-static {v1}, Lcom/android/internal/telephony/PhoneBase;->file2String(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mPsLowCoverageConf:Ljava/lang/String;
    ...
    .line 425
    const-string v1, "ims_mode_enable_key"

    invoke-interface {v0, v1, v6}, Landroid/content/SharedPreferences;->getInt(Ljava/lang/String;I)I

    move-result v1

    iput v1, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I
    ...
    const-string v3, "Init mImsMode "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I
...
.method private getImsMode(Landroid/os/Message;)V
    .locals 5
    .param p1, "onCompleted"    # Landroid/os/Message;
    ...
    .line 2237
    .local v1, "request":[B
    invoke-static {v1}, Lcom/android/internal/telephony/PhoneBase;->createBufferWithNativeByteOrder([B)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p0, v0, v2, v3}, Lcom/android/internal/telephony/PhoneBase;->addMotRilHookHeader(Ljava/nio/ByteBuffer;II)V

    .line 2240
    sget-boolean v2, Lcom/android/internal/telephony/PhoneBase;->LOCAL_DEBUG:Z
    ...
    .line 2241
    :cond_0
    invoke-virtual {p0, v1, p1}, Lcom/android/internal/telephony/PhoneBase;->invokeOemRilRequestRaw([BLandroid/os/Message;)V
...
.method private handleLowCoverageNotification([B)V
    .locals 11
    .param p1, "data"    # [B
    ...
    invoke-static {p1, v8}, Ljava/util/Arrays;->copyOf([BI)[B

    move-result-object v6

    sget-object v7, Lcom/android/internal/telephony/PhoneBase;->UNSOL_OEM_LOW_COVERAGE_CHANGE:[B
    ...
    .line 2170
    .local v2, "isLowPsCoverage":Z
    :goto_1
    sget-boolean v4, Lcom/android/internal/telephony/PhoneBase;->LOCAL_DEBUG:Z
    ...
    const-string v7, "value, isLowCsCoverage:"
    ...
    const-string v7, "; isLowPsCoverage:"
    ...
    .line 2172
    :cond_0
    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneBase;->mIsCsCoverageLow:Z

    if-ne v1, v4, :cond_1

    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneBase;->mIsPsCoverageLow:Z

    if-eq v2, v4, :cond_2

    .line 2174
    :cond_1
    iput-boolean v1, p0, Lcom/android/internal/telephony/PhoneBase;->mIsCsCoverageLow:Z
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/internal/telephony/PhoneBase;->notifyLowCoverageChange(B[B)V

    .line 2184
    .end local v1    # "isLowCsCoverage":Z
    .end local v2    # "isLowPsCoverage":Z
    .end local v3    # "lowCoverageTag":B
    :cond_2
    :goto_2
    return-void

    .restart local v3    # "lowCoverageTag":B
    :cond_3
    move v1, v5
    ...
    .restart local v1    # "isLowCsCoverage":Z
    :cond_4
    move v2, v5
    ...
    invoke-static {p1, v9, v4}, Ljava/util/Arrays;->copyOfRange([BII)[B
...
.method private mvnoMatches(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 4
    .param p1, "spn"    # Ljava/lang/String;
    .param p2, "imsi"    # Ljava/lang/String;
    .param p3, "gid1"    # Ljava/lang/String;
    .param p4, "mvno_type"    # Ljava/lang/String;
    .param p5, "mvno_match_data"    # Ljava/lang/String;
    ...
    invoke-direct {p0, p5, p2}, Lcom/android/internal/telephony/PhoneBase;->imsiMatches(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private notifyLowCoverageChange(B[B)V
    ...
    const-string v11, "android.intent.action.ACTION_NETWORK_COVERAGE_CHANGE"
    ...
    invoke-virtual {v5, v11, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;B)Landroid/content/Intent;

    .line 2087
    if-nez p1, :cond_3

    .line 2088
    const-string v11, "cs_low"

    iget-boolean v12, p0, Lcom/android/internal/telephony/PhoneBase;->mIsCsCoverageLow:Z

    invoke-virtual {v5, v11, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    .line 2089
    const-string v11, "ps_low"

    iget-boolean v12, p0, Lcom/android/internal/telephony/PhoneBase;->mIsPsCoverageLow:Z

    invoke-virtual {v5, v11, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    .line 2091
    iget-object v11, p0, Lcom/android/internal/telephony/PhoneBase;->mCsLowCoverageConf:Ljava/lang/String;

    if-eqz v11, :cond_0

    .line 2092
    const-string v11, "bgdata_restricted"
    ...
    :cond_0
    :goto_0
    sget-boolean v11, Lcom/android/internal/telephony/PhoneBase;->LOCAL_DEBUG:Z
    ...
    const-string v13, "; EXTRA_COVERAGE_TAG:"
    ...
    invoke-virtual {v5, v13, v14}, Landroid/content/Intent;->getByteExtra(Ljava/lang/String;B)B
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_LOW:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "cs_low"
    ...
    const-string v13, "; EXTRA_PS_COVERAGE_LOW:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "ps_low"
    ...
    const-string v13, "; EXTRA_BGDATA_RESTRICTED:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "bgdata_restricted"
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_STATE:"
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_RAT"
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_QRADIO:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "qradio"
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_CELLID:"
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_RATCOUNT:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "ratcount"

    const/4 v14, 0x0

    invoke-virtual {v5, v13, v14}, Landroid/content/Intent;->getShortExtra(Ljava/lang/String;S)S
    ...
    const-string v13, "; EXTRA_CS_COVERAGE_CELLCOUNT:"

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "cellcount"
    ...
    invoke-static {v4, v11}, Lcom/android/internal/telephony/PhoneBase;->byteArrayToInt([BZ)I
    ...
    invoke-virtual {v5, v11, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;B)Landroid/content/Intent;

    .line 2114
    const-string v11, "rat"

    invoke-virtual {v5, v11, v7}, Landroid/content/Intent;->putExtra(Ljava/lang/String;B)Landroid/content/Intent;

    .line 2115
    const-string v11, "qradio"

    invoke-virtual {v5, v11, v6}, Landroid/content/Intent;->putExtra(Ljava/lang/String;B)Landroid/content/Intent;
    ...
    .line 2123
    .local v9, "ratCountArray":[B
    const/4 v11, 0x0

    invoke-static {v9, v11}, Lcom/android/internal/telephony/PhoneBase;->byteArrayToShort([BZ)S
    ...
    .line 2126
    .local v2, "cellCountArray":[B
    const/4 v11, 0x0

    invoke-static {v2, v11}, Lcom/android/internal/telephony/PhoneBase;->byteArrayToShort([BZ)S
    ...
    .line 2129
    const-string v11, "ratcount"

    invoke-virtual {v5, v11, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;S)Landroid/content/Intent;

    .line 2130
    const-string v11, "cellcount"

    invoke-virtual {v5, v11, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;S)Landroid/content/Intent;
...
.method private setImsModeSp(I)V
    .locals 3
    .param p1, "imsMode"    # I
    ...
    const-string v2, "ims_mode_enable_key"
...
.method public contSetImsMode()V
    ...
    .line 2366
    iget v0, p0, Lcom/android/internal/telephony/PhoneBase;->mConSetImsMode:I
    ...
    const-string v1, " mConSetImsMode is invalid, return "
    ...
    const-string v2, "contSetImsMode() set IMS mode to "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/internal/telephony/PhoneBase;->mConSetImsMode:I
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z

    .line 2372
    iput v3, p0, Lcom/android/internal/telephony/PhoneBase;->mConSetImsMode:I
...
.method protected fillMvnoInfoToMap(Lcom/android/internal/telephony/uicc/IccRecords;Landroid/content/ContentValues;)V
    .locals 6
    ...
    const-string v5, "fillMvnoInfoToMap, r == null || map == null"
    ...
    const-string v5, "fillMvnoInfoToMap, operator is null or empty"
    ...
    .line 1910
    invoke-virtual/range {v0 .. v5}, Lcom/android/internal/telephony/PhoneBase;->fillMvnoInfoToMapDetailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)V

    goto :goto_0
.end method

.method protected fillMvnoInfoToMapDetailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)V
    .locals 7
    .param p1, "spn"    # Ljava/lang/String;
    .param p2, "imsiSIM"    # Ljava/lang/String;
    .param p3, "gid1"    # Ljava/lang/String;
    .param p4, "operator"    # Ljava/lang/String;
    .param p5, "map"    # Landroid/content/ContentValues;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/internal/telephony/PhoneBase;->fillMvnoInfoToMapDetailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;Z)V

    .line 1917
    return-void
.end method

.method protected fillMvnoInfoToMapDetailed(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;Z)V
    .locals 22
    .param p1, "spn"    # Ljava/lang/String;
    .param p2, "imsiSIM"    # Ljava/lang/String;
    .param p3, "gid1"    # Ljava/lang/String;
    ...
    .line 1931
    .local v14, "currentAPNs":Ljava/util/List;, "Ljava/util/List<Landroid/content/ContentValues;>;"
    const/4 v12, 0x0

    .line 1933
    .local v12, "curAPN":Landroid/content/ContentValues;
    :try_start_0
    ...
    .local v20, "mvnoMatchData":Ljava/lang/String;
    move-object v13, v12

    .line 1940
    .end local v12    # "curAPN":Landroid/content/ContentValues;
    .local v13, "curAPN":Landroid/content/ContentValues;
    :goto_0
    :try_start_1
    ...
    .line 1941
    .end local v13    # "curAPN":Landroid/content/ContentValues;
    .restart local v12    # "curAPN":Landroid/content/ContentValues;
    :try_start_2
    const-string v1, "_id"
    ...
    .line 1946
    .local v9, "cursorMvnoType":Ljava/lang/String;
    ...
    .line 1948
    .local v10, "cursorMvnoData":Ljava/lang/String;
    if-eqz v21, :cond_7
    ...
    .line 1982
    .end local v9    # "cursorMvnoType":Ljava/lang/String;
    .end local v10    # "cursorMvnoData":Ljava/lang/String;
    .end local v18    # "id":I
    .end local v20    # "mvnoMatchData":Ljava/lang/String;
    ...
    .line 1989
    .local v19, "idSelectionBuff":Ljava/lang/StringBuffer;
    const-string v1, " AND "
    ...
    .end local v19    # "idSelectionBuff":Ljava/lang/StringBuffer;
    .restart local v9    # "cursorMvnoType":Ljava/lang/String;
    .restart local v10    # "cursorMvnoData":Ljava/lang/String;
    .restart local v18    # "id":I
    .restart local v20    # "mvnoMatchData":Ljava/lang/String;
    ...
    const-string v3, "fillMvnoInfoToMap, Exception = "
    ...
    :try_start_6
    invoke-direct/range {v5 .. v10}, Lcom/android/internal/telephony/PhoneBase;->mvnoMatches(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .restart local v19    # "idSelectionBuff":Ljava/lang/StringBuffer;
    :cond_a
    const-string v1, " )"
    ...
    const-string v3, "fillMvnoInfoToMap, selection = "
    ...
    .line 1998
    const-string v1, "special_where_clause"
    ...
    .line 1982
    .end local v12    # "curAPN":Landroid/content/ContentValues;
    .restart local v13    # "curAPN":Landroid/content/ContentValues;
    .restart local v20    # "mvnoMatchData":Ljava/lang/String;
    .restart local v21    # "mvnoType":Ljava/lang/String;
    :catchall_1
    move-exception v1
...
.method public getImsMode()Z
    ...
    .prologue
    .line 2233
    iget v0, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I
...
.method public getImsRegistrationState()Z
    ...
    :cond_0
    invoke-virtual {v0}, Lcom/android/internal/telephony/ServiceStateTracker;->getImsRegistrationState()Z
...
.method public getTuneAway(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->getTuneAway(Landroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v9, "Event EVENT_UNSOL_OEM_HOOK_RAW data="
    ...
    const-string v7, "com.motorola.android.intent.action.ACTION_UNSOL_OEM_HOOK_RAW"
    ...
    .line 517
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/PhoneBase;->handleLowCoverageNotification([B)V
    ...
    const-string v8, "EVENT_SET_LOW_COVERAGE_CONF"
    ...
    const-string v8, "EVENT_RIL_CONNECTED"
    ...
    const-string v9, "mImsMode = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/PhoneBase;->getImsMode(Landroid/os/Message;)V
    ...
    const-string v10, "EVENT_GET_IMS_MODE"
    ...
    .local v4, "imsMode":I
    :goto_1
    const-string v7, "persist.radio.calls.on.ims"
    ...
    .line 549
    iget v7, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    if-ne v7, v8, :cond_6

    .line 550
    iput v9, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    .line 551
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/PhoneBase;->setImsModeSp(I)V
    ...
    invoke-virtual {p0, v9, v7}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z
    ...
    .line 559
    iput v4, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    .line 560
    iget v7, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    invoke-direct {p0, v7}, Lcom/android/internal/telephony/PhoneBase;->setImsModeSp(I)V
    ...
    invoke-virtual {p0, v8, v7}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z
    ...
    const-string v8, "getImsMode Command returned null response "
    ...
    const-string v8, "EVENT_SET_IMS_MODE"
    ...
    :cond_d
    :goto_4
    iput-boolean v9, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeInProgress:Z

    .line 582
    iget-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsMode:Z

    iget-boolean v8, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeBak:Z

    if-eq v7, v8, :cond_0

    .line 583
    iget-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeBak:Z

    invoke-virtual {p0, v11}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v8

    invoke-virtual {p0, v7, v8}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z
    ...
    const-string v10, "setImsMode successfully! mImsMode is "

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v10, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v10, " mSetImsMode is "

    invoke-virtual {v8, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v10, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsMode:Z
...
.method public registerForCallTypeChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .prologue
    .line 2380
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mCallTypeChangeRegistrants:Landroid/os/RegistrantList;
...
.method public setImsMode(Z)Z
    ...
    const-string v5, "setImsMode: mode is "
    ...
    iget v1, p0, Lcom/android/internal/telephony/PhoneBase;->mImsMode:I
    ...
    const-string v3, "setImsMode: no changed"
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/PhoneBase;->setImsModeSp(I)V

    .line 2260
    iget-boolean v1, p0, Lcom/android/internal/telephony/PhoneBase;->mRoamMode:Z
    ...
    const-string v4, "Roam mode disabled. mRoamMode is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneBase;->mRoamMode:Z
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/CallManager;->isImsPhoneActive()Z
    ...
    const-string v4, "IMS call is ongoing, close IMS mode latter. "
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z
...
.method protected setImsMode(ZLandroid/os/Message;)Z
    .locals 6
    .param p1, "mode"    # Z
    ...
    .line 2278
    iput-boolean p1, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeBak:Z

    .line 2279
    iget-boolean v2, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsModeInProgress:Z
    ...
    const-string v4, "mSetImsModeInProgress, set it latter. "
    ...
    .line 2283
    :cond_0
    iput-boolean p1, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsMode:Z
    ...
    const-string v5, "setImsMode: mSetImsMode is "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/internal/telephony/PhoneBase;->mSetImsMode:Z
    ...
    .line 2292
    :cond_1
    invoke-virtual {p0, v1, p2}, Lcom/android/internal/telephony/PhoneBase;->invokeOemRilRequestRaw([BLandroid/os/Message;)V
...
.method public setRoamingImsMode(Z)Z
    .locals 4
    .param p1, "roamMode"    # Z
    ...
    const-string v3, "setRoamImsMode: roam mode is "
    ...
    .line 2342
    iget-boolean v0, p0, Lcom/android/internal/telephony/PhoneBase;->mRoamMode:Z
    ...
    const-string v2, "setRoamingImsMode: no change"
    ...
    .line 2347
    :cond_0
    iput-boolean p1, p0, Lcom/android/internal/telephony/PhoneBase;->mRoamMode:Z
    ...
    const-string v3, "IMS mode is disabled. mImsMode is "
    ...
    const-string v2, "IMS call is ongoing, close IMS mode latter. "
    ...
    :goto_1
    iput v0, p0, Lcom/android/internal/telephony/PhoneBase;->mConSetImsMode:I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/internal/telephony/PhoneBase;->setImsMode(ZLandroid/os/Message;)Z
