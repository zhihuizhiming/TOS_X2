...
.field private static final ACTION_UICC_RESET_FINISH:Ljava/lang/String; = "com.motorola.intent.action.UICC_RESET_FINISH"

.field private static final ACTION_UICC_RESET_START:Ljava/lang/String; = "com.motorola.intent.action.UICC_RESET_START"
...
.field private static final MOT_UICC_PRE_RESET:I = 0x0
...
.field final OEMHOOK_UNSOL_UICC_RESET_IND:I

.field final OEMHOOK_UNSOL_WIFI_SAFE_CHANNELS_CHANGED:I
...
.method public constructor <init>(Landroid/content/Context;IILjava/lang/Integer;)V
    ...
    iput v4, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_WIFI_SAFE_CHANNELS_CHANGED:I
    ...
    iput v4, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_GENERIC:I

    .line 276
    const/4 v4, 0x2

    iput v4, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_TUNNELING_SERVICE_EMBMS:I

    .line 277
    const/16 v4, 0x19

    iput v4, p0, Lcom/android/internal/telephony/RIL;->EMBMS_MESSAGE_UNSOLSIB16_COVERAGE:I
    ...
    iput v4, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_SPEECH_CODEC_IND:I

    .line 284
    const v4, 0x4000e00

    iput v4, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_UICC_RESET_IND:I
    ...
    .line 340
    iput-boolean v6, p0, Lcom/android/internal/telephony/RIL;->mSpeechCodecEnabled:Z
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/RIL;->mSpeechCodecEnabled:Z
...
.method private handleTunnelingServiceEMBMS(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1, p1}, Lcom/android/internal/telephony/RIL$TLV;->access$1000(Lcom/android/internal/telephony/RIL$TLV;Ljava/nio/ByteBuffer;)V

    .line 3612
    # getter for: Lcom/android/internal/telephony/RIL$TLV;->value:[B
    invoke-static {v1}, Lcom/android/internal/telephony/RIL$TLV;->access$1100(Lcom/android/internal/telephony/RIL$TLV;)[B
...
.method private notifySIB16Coverage([B)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/BaseCommands;->mSIB16CoverageRegistrants:Landroid/os/RegistrantList;
...
.method private notifyUiccReset([B)V
    .locals 7
    .param p1, "data"    # [B
    ...
    .line 3550
    .local v2, "nfcExtras":Landroid/nfc/INfcAdapterExtras;
    ...
    const-string v4, "nfcExtras is null!"
    ...
    const-string v4, "Calling uiccResetStart()"
    ...
    invoke-interface {v2, v3}, Landroid/nfc/INfcAdapterExtras;->uiccResetStart(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "uiccResetStart exception: "
    ...
    const-string v5, "Calling uiccResetFinish() "
    ...
    invoke-interface {v2, v3}, Landroid/nfc/INfcAdapterExtras;->uiccResetFinish(Ljava/lang/String;)V
    :try_end_1
    ...
    const-string v5, "uiccResetFinish exception: "
...
.method private processUnsolOemhookResponse(Ljava/nio/ByteBuffer;)V
    ...
    .line 3450
    :sswitch_4
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->broadcastWifiChannelsChangedIntent([B)V
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/CallManager;->isImsPhoneActive()Z
    ...
    .line 3209
    const-string v25, "Discard RIL_UNSOL_CDMA_INFO_REC of secondincoming 1x Call during active VoLTE call"
    ...
    const-string v26, "OEM ID check Passed"
    ...
    .local v18, "responseId":I
    const/16 v19, 0x0

    .line 3239
    .local v19, "responseSize":I
    :try_start_4
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/RIL;->notifyUiccReset([B)V

    goto/16 :goto_0

    .line 3252
    .end local v17    # "responseData":[B
    :cond_a
    const-string v25, "RILJ"

    const-string v26, "External OEM message, to be notified"
    ...
    .end local v18    # "responseId":I
    .end local v19    # "responseSize":I
    :pswitch_47
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/telephony/RIL;->setRadioPower(ZZLandroid/os/Message;)V
    ...
    .line 3241
    .restart local v12    # "oemHookResponse":Ljava/nio/ByteBuffer;
    .restart local v18    # "responseId":I
    .restart local v19    # "responseSize":I
    :catch_2
    move-exception v25
...
.method public getTuneAway(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v1, v0, p1}, Lcom/android/internal/telephony/RIL;->sendOemRilRequestRaw(IBLandroid/os/Message;)V
...
.method protected notifySimRefresh([B)V
    ...
    .line 3648
    .local v0, "ar":Landroid/os/AsyncResult;
    iget-object v1, p0, Lcom/android/internal/telephony/BaseCommands;->mSimRefreshRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v2, "SIM_REFRESH notified to registrants"
...
.method public setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lcom/android/internal/telephony/RIL;->setRadioPower(ZZLandroid/os/Message;)V

    .line 1583
    return-void
.end method

.method public setRadioPower(ZZLandroid/os/Message;)V
    .locals 5
    .param p1, "on"    # Z
    .param p2, "resetMT"    # Z
    .param p3, "result"    # Landroid/os/Message;
    ...
    :cond_3
    const-string v1, " DO_NOT_RESET_MT"
