...
.field private static final ATTR_NUMERIC:Ljava/lang/String; = "numeric"

.field private static final BUF_CONFIG_PATH:Ljava/lang/String; = "etc/buffers-conf.xml"

.field private static final CAL_FACTOR:I = 0x4
...
.field private static final RTT_CONFIG_PATH:Ljava/lang/String; = "etc/rtt-conf.xml"

.field protected static final SAMPLE_INTERVAL_ELAPSED_REQUEST_CODE:I = 0x0

.field private static final TAG:Ljava/lang/String; = "ConnectivityService"

.field private static final TAG_BUFFERS:Ljava/lang/String; = "buffers"

.field private static final TAG_NETWORK:Ljava/lang/String; = "network"
...
.field private static final TAG_RTT:Ljava/lang/String; = "rtt"
...
.field private static final def_rtt:I = 0x64

.field private static final max_rtt:I = 0x1f4

.field private static final min_rtt:I = 0x5

.field private static final rmin_2G:Ljava/lang/String; = "4096"

.field private static final rmin_3G:Ljava/lang/String; = "131072"

.field private static final rmin_4G:Ljava/lang/String; = "524288"

.field private static sFeatureEnableHipri:Ljava/lang/String; = null

.field private static sHipriPermissionCheck:Z = false

.field private static sServiceInstance:Lcom/android/server/ConnectivityService; = null

.field private static sTypeMobileHipri:I = 0x0

.field private static final wmin_2G:Ljava/lang/String; = "4096"

.field private static final wmin_3G:Ljava/lang/String; = "131072"

.field private static final wmin_4G:Ljava/lang/String; = "262144"
...
.field private mEnableProvision:Z
...
.field private mOldBufferSizes:Ljava/lang/String;
...
.field mapIfaceToMtu:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field private tetherReceiver:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ConnectivityService;->sHipriPermissionCheck:Z

    .line 230
    const/4 v0, 0x5

    sput v0, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I

    .line 231
    const-string v0, "enableHIPRI"

    sput-object v0, Lcom/android/server/ConnectivityService;->sFeatureEnableHipri:Ljava/lang/String;
...
.method protected constructor <init>()V
    ...
    .line 297
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->mHotspotState:Z
    ...
    .line 446
    iput-object v2, p0, Lcom/android/server/ConnectivityService;->mOldBufferSizes:Ljava/lang/String;
    ...
    .line 469
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->mEnableProvision:Z
    ...
    iput-object v0, p0, Lcom/android/server/ConnectivityService;->mapIfaceToMtu:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/android/server/ConnectivityService;->tetherReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Lcom/android/server/ConnectivityService$NetworkFactory;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->mHotspotState:Z
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mOldBufferSizes:Ljava/lang/String;
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->mEnableProvision:Z
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mapIfaceToMtu:Ljava/util/Map;
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->tetherReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 745
    .local v35, "tetherFilter":Landroid/content/IntentFilter;
    ...
    iget-object v3, v0, Lcom/android/server/ConnectivityService;->tetherReceiver:Landroid/content/BroadcastReceiver;
    ...
    sput-boolean v2, Lcom/android/server/ConnectivityService;->sHipriPermissionCheck:Z
    :try_end_5
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_5} :catch_5

    .line 758
    :goto_11
    sget-boolean v2, Lcom/android/server/ConnectivityService;->sHipriPermissionCheck:Z

    if-eqz v2, :cond_1c

    const-string v2, "enableSTDHIPRI"

    :goto_12
    sput-object v2, Lcom/android/server/ConnectivityService;->sFeatureEnableHipri:Ljava/lang/String;
    ...
    :goto_13
    sput v2, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
    ...
    const-string v4, "Multiple APN HiPri Permission ckeck supported? "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-boolean v4, Lcom/android/server/ConnectivityService;->sHipriPermissionCheck:Z
    ...
    .end local v35    # "tetherFilter":Landroid/content/IntentFilter;
    :catch_4
    move-exception v12
    ...
    .restart local v35    # "tetherFilter":Landroid/content/IntentFilter;
    :catch_5
    move-exception v12
...
.method static synthetic access$1100(Lcom/android/server/ConnectivityService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;

    .prologue
    .line 183
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->mEnableProvision:Z
...
.method static synthetic access$4300(Lcom/android/server/ConnectivityService;)Z
    ...
    .prologue
    .line 183
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->isWifiTethered()Z
...
.method static synthetic access$4400(Lcom/android/server/ConnectivityService;)Z
    ...
    .prologue
    .line 183
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->mHotspotState:Z
...
.method static synthetic access$4402(Lcom/android/server/ConnectivityService;Z)Z
    ...
    .prologue
    .line 183
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->mHotspotState:Z
...
.method static synthetic access$4500()I
    ...
    .prologue
    .line 183
    sget v0, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
...
.method static synthetic access$5600()Ljava/lang/String;
    ...
    .prologue
    .line 183
    sget-object v0, Lcom/android/server/ConnectivityService;->sFeatureEnableHipri:Ljava/lang/String;
...
.method private calculateBuffers(Landroid/net/NetworkStateTracker;II)Ljava/lang/String;
    .locals 18
    .param p1, "nt"    # Landroid/net/NetworkStateTracker;
    .param p2, "bandwidth_ul"    # I
    .param p3, "bandwidth_dl"    # I
    ...
    .line 5839
    .local v1, "buffers":Ljava/lang/StringBuilder;
    const/4 v11, 0x0
    ...
    .line 5844
    .local v13, "winScale":I
    const/4 v14, 0x1

    .line 5846
    .local v14, "ws_factor":I
    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->getNetworkNumeric()Ljava/lang/String;
    ...
    .line 5848
    :cond_0
    const-string v15, "Obtained invalid network numeric."
    ...
    .line 5852
    :cond_1
    invoke-interface/range {p1 .. p1}, Landroid/net/NetworkStateTracker;->getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    const-string v16, "/proc/sys/net/ipv4/tcp_adv_win_scale"
    ...
    invoke-static/range {v15 .. v17}, Landroid/os/FileUtils;->readTextFile(Ljava/io/File;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v10, v6}, Lcom/android/server/ConnectivityService;->getNetworkRtt(Ljava/lang/String;I)I
    ...
    const-string v16, "Obtained RTT for "
    ...
    const-string v16, "Invalid network RTT: "
    ...
    .line 5856
    :cond_3
    const-string v15, "NetworkInfo is null, cannot calculate TCP buffers."
    ...
    iget-object v15, v0, Lcom/android/server/ConnectivityService;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    const-string v16, "Unsupported network type: "
    ...
    const-string v16, " to calculate TCP buffers."
    ...
    const-string v16, "Unsupported network class: "
...
.method private checkAndConvertHipri(I)I
    ...
    .prologue
    .line 5540
    sget-boolean v0, Lcom/android/server/ConnectivityService;->sHipriPermissionCheck:Z
...
.method private convertNetTypeToTag(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    ...
    .line 5795
    .end local p1    # "netType":Ljava/lang/String;
    :cond_1
    :goto_0
    return-object p1

    .line 5778
    .restart local p1    # "netType":Ljava/lang/String;
    :cond_2
    const-string v1, "2ghotspot"
    ...
    .line 5781
    const-string v0, "hotspot2g2"

    goto :goto_1

    .line 5782
    :cond_5
    const-string v1, "3ghotspot"
    ...
    .line 5783
    const-string v0, "hotspot3g"

    goto :goto_1

    .line 5784
    :cond_6
    const-string v1, "3ghotspot2"
    ...
    .line 5785
    const-string v0, "hotspot3g2"

    goto :goto_1

    .line 5786
    :cond_7
    const-string v1, "4ghotspot"
...
.method private enforcePreference()V
    ...
    const-string v2, "try to reconnect new NetPreference:"
...
.method private getNetworkNumeric()Ljava/lang/String;
    .locals 5
    ...
    .line 5706
    .local v0, "dds":I
    invoke-virtual {v2, v0}, Landroid/telephony/MSimTelephonyManager;->getNetworkOperator(I)Ljava/lang/String;
    ...
    const-string v4, "get DSDS data network operator numeric is: "
    ...
    const-string v4, "get data network operator numeric is: "
...
.method private getNetworkRtt(Ljava/lang/String;I)I
    .locals 12
    ...
    .line 5957
    .end local v8    # "rtt":I
    .restart local v7    # "rtt":I
    :cond_0
    packed-switch p2, :pswitch_data_0

    .line 5968
    const-string v5, "delay_3G"
    ...
    const-string v10, "etc/rtt-conf.xml"
    ...
    invoke-static {v6, v10}, Lcom/android/internal/util/XmlUtils;->beginDocument(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    ...
    invoke-interface {v6, v10, v5}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "Get RTT value: "
    ...
    :goto_5
    :try_start_5
    const-string v10, "RTT config file not found"
    ...
    const-string v11, "Xml parser exception reading rtt config file: "
    ...
    const-string v11, "I/O exception reading rtt config file: "
...
.method private getNetworkTcpBufferSizes(Landroid/net/NetworkStateTracker;Ljava/lang/String;)Ljava/lang/String;
    .locals 13
    .param p1, "nt"    # Landroid/net/NetworkStateTracker;
    ...
    .line 5659
    .local v3, "buffers":Ljava/lang/String;
    const/4 v9, 0x0

    .line 5661
    .local v9, "rat":Ljava/lang/String;
    if-nez p1, :cond_0

    move-object v4, v3

    .line 5694
    .end local v3    # "buffers":Ljava/lang/String;
    .local v4, "buffers":Ljava/lang/String;
    :goto_0
    return-object v4

    .line 5663
    .end local v4    # "buffers":Ljava/lang/String;
    .restart local v3    # "buffers":Ljava/lang/String;
    :cond_0
    ...
    .end local v3    # "buffers":Ljava/lang/String;
    .restart local v4    # "buffers":Ljava/lang/String;
    goto :goto_0
    ...
    .restart local v3    # "buffers":Ljava/lang/String;
    :cond_1
    invoke-virtual {v8}, Landroid/net/LinkProperties;->getBandwidth()Ljava/util/Collection;

    move-result-object v0

    .line 5667
    .local v0, "bandwidth":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/String;>;"
    ...
    .line 5671
    .local v1, "bandwidth_dl":I
    if-lez v2, :cond_2

    if-lez v1, :cond_2

    .line 5672
    const-string v11, "Use network passed bandwidth to calcaulte buffers!"

    invoke-static {v11}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 5673
    invoke-direct {p0, p1, v2, v1}, Lcom/android/server/ConnectivityService;->calculateBuffers(Landroid/net/NetworkStateTracker;II)Ljava/lang/String;
    ...
    .line 5679
    .end local v1    # "bandwidth_dl":I
    .end local v2    # "bandwidth_ul":I
    .end local v4    # "buffers":Ljava/lang/String;
    ...
    .restart local v3    # "buffers":Ljava/lang/String;
    :cond_4
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->getNetworkNumeric()Ljava/lang/String;
    ...
    .line 5690
    invoke-direct {p0, v7, v9}, Lcom/android/server/ConnectivityService;->obtainBuffers(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .restart local v3    # "buffers":Ljava/lang/String;
    :cond_5
    const-string v11, "Cannot get the network numeric!"
...
.method private handleConnectivityChange(IZ)V
    ...
    invoke-direct {p0, v7, v1, v11, v2}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;ZZ)Z
    ...
    .line 2797
    iget-object v12, p0, Lcom/android/server/ConnectivityService;->mVpns:Landroid/util/SparseArray;
    ...
    check-cast v11, Lcom/android/server/connectivity/Vpn;

    const/4 v13, 0x0

    invoke-virtual {v11, v5, v13}, Lcom/android/server/connectivity/Vpn;->interfaceStatusChanged(Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v7}, Lcom/android/server/connectivity/Nat464Xlat;->isRunningClat(Landroid/net/LinkProperties;)Z
    ...
    invoke-virtual {v11, v12}, Lcom/android/server/connectivity/Tethering;->handleTetherIfaceChange(Landroid/net/NetworkInfo;)V
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    iget-object v0, v0, Lcom/android/server/ConnectivityService;->mapIfaceToMtu:Ljava/util/Map;
    ...
    invoke-direct {v0, v7}, Lcom/android/server/ConnectivityService;->passOrConvertHipriIntent(Landroid/content/Intent;)Z
    ...
    const-string v20, "passOrConvertHipriIntent fail, block intent("
    ...
    iget-object v0, v0, Lcom/android/server/ConnectivityService;->mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ConnectivityService$InternetDetection;->resetInfo(I)V
...
.method private handleDnsConfigurationChange(I)V
    ...
    .line 3313
    iget-object v2, p0, Lcom/android/server/ConnectivityService;->mDnsLock:Ljava/lang/Object;
    ...
    invoke-interface {v0, v4}, Landroid/os/INetworkManagementService;->setDefaultInterfaceForDns(Ljava/lang/String;)V
    :try_end_4
    ...
    const-string v4, "exception setting default dns interface: "
...
.method private handleMobileProvisioningAction(Ljava/lang/String;)V
    ...
    .line 5155
    sget v3, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
...
.method private isBufferSizeValid(Ljava/lang/String;)Z
    .locals 6
...
.method private isMobileDataStateTrackerReady()Z
    ...
    sget v2, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
...
.method private isWifiTethered()Z
    .locals 7
    ...
    invoke-virtual {v5, v2}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    const-string v6, "WiFi Tethered already!"
    ...
    const-string v6, "WiFi NOT Tethered!"
...
.method private obtainBuffers(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 11
    .param p1, "numeric"    # Ljava/lang/String;
    ...
    .line 5730
    .local v8, "rat":Ljava/lang/String;
    if-eqz p1, :cond_0
    ...
    .line 5767
    .end local v0    # "buffers":Ljava/lang/String;
    .local v1, "buffers":Ljava/lang/String;
    :goto_0
    return-object v1

    .line 5731
    .end local v1    # "buffers":Ljava/lang/String;
    .restart local v0    # "buffers":Ljava/lang/String;
    :cond_1
    invoke-direct {p0, p2}, Lcom/android/server/ConnectivityService;->convertNetTypeToTag(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v9, "etc/buffers-conf.xml"
    ...
    .line 5767
    .end local v0    # "buffers":Ljava/lang/String;
    .restart local v1    # "buffers":Ljava/lang/String;
    goto :goto_0
    ...
    const-string v10, "Get values from configure: "
    ...
    :goto_4
    :try_start_5
    const-string v9, "TCP buffer config file not found"
    ...
    const-string v10, "Xml parser exception reading buffer config file: "
    ...
    const-string v10, "I/O exception reading buffer config file: "
...
.method private switchKey(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    ...
    .line 5629
    .local v0, "rr":Ljava/lang/String;
    const-string v1, "net.tcp.buffersize.cdma"
    ...
    const-string v1, "net.tcp.buffersize.1xrtt"
    ...
    .line 5631
    :cond_0
    const-string v0, "net.tcp.buffersize.2ghotspot2"
    ...
    .line 5632
    :cond_1
    const-string v1, "net.tcp.buffersize.gprs"
    ...
    const-string v1, "net.tcp.buffersize.edge"
    ...
    .line 5635
    :cond_2
    const-string v0, "net.tcp.buffersize.2ghotspot"

    goto :goto_0

    .line 5636
    :cond_3
    const-string v1, "net.tcp.buffersize.evdo"
    ...
    const-string v1, "net.tcp.buffersize.evdo_b"
    ...
    const-string v1, "net.tcp.buffersize.ehrpd"
    ...
    .line 5640
    :cond_4
    const-string v0, "net.tcp.buffersize.3ghotspot2"

    goto :goto_0

    .line 5641
    :cond_5
    const-string v1, "net.tcp.buffersize.umts"
    ...
    const-string v1, "net.tcp.buffersize.hsdpa"
    ...
    const-string v1, "net.tcp.buffersize.hsupa"
    ...
    const-string v1, "net.tcp.buffersize.hspap"
    ...
    const-string v1, "net.tcp.buffersize.hspa"
    ...
    .line 5647
    :cond_6
    const-string v0, "net.tcp.buffersize.3ghotspot"

    goto :goto_0

    .line 5648
    :cond_7
    const-string v1, "net.tcp.buffersize.lte"
    ...
    .line 5649
    const-string v0, "net.tcp.buffersize.4ghotspot"
...
.method private updateMtuSizeSettings(Landroid/net/NetworkStateTracker;)V
    ...
    invoke-virtual {v4}, Landroid/net/LinkProperties;->getMtu()I
    ...
    .line 2964
    :cond_3
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mapIfaceToMtu:Ljava/util/Map;
    ...
    const-string v5, "MTU already set for iface: "
    ...
    const-string v5, "MTU updated for iface: "
    ...
    invoke-interface {v4, v1, v2}, Landroid/os/INetworkManagementService;->setMtu(Ljava/lang/String;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, " added with MTU: "
...
.method private updateNetworkSettings(Landroid/net/NetworkStateTracker;)V
    ...
    .line 2996
    invoke-direct {p0, v3}, Lcom/android/server/ConnectivityService;->switchKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "Setting HotSpot TCP values from ["
    ...
    .line 2999
    :cond_0
    invoke-direct {p0, p1, v3}, Lcom/android/server/ConnectivityService;->getNetworkTcpBufferSizes(Landroid/net/NetworkStateTracker;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3019
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mOldBufferSizes:Ljava/lang/String;
    ...
    .line 3028
    :cond_5
    invoke-direct {p0, v0}, Lcom/android/server/ConnectivityService;->isBufferSizeValid(Ljava/lang/String;)Z
    ...
    .line 3030
    iput-object v0, p0, Lcom/android/server/ConnectivityService;->mOldBufferSizes:Ljava/lang/String;

    goto :goto_1

    .line 3032
    :cond_6
    const-string v6, "Invalid tcp buffer sizes, ignore!"
...
.method public checkMobileProvisioning(I)I
    ...
    sget v6, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
    ...
    :try_start_2
    sget v7, Lcom/android/server/ConnectivityService;->sTypeMobileHipri:I
...
.method public launchInternetDetection(ILjava/lang/String;)I
    ...
    .line 6203
    iget-object v1, p0, Lcom/android/server/ConnectivityService;->mCaptivePortalTracker:Landroid/net/CaptivePortalTracker;

    invoke-virtual {v1}, Landroid/net/CaptivePortalTracker;->getCaptivePortalTargetServer()Ljava/lang/String;

    move-result-object p2

    .line 6205
    :cond_1
    iget-object v1, p0, Lcom/android/server/ConnectivityService;->mInternetDetection:Lcom/android/server/ConnectivityService$InternetDetection;

    invoke-virtual {v1, v0, p2}, Lcom/android/server/ConnectivityService$InternetDetection;->detectExternal(Landroid/net/NetworkInfo;Ljava/lang/String;)V
