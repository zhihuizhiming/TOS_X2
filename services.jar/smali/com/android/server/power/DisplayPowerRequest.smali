...
.field public minAllowedScreenBrightnessOverride:I
...
.method public constructor <init>()V
    ...
    .line 87
    iput-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    .line 88
    iput v2, p0, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    .line 89
    iput v2, p0, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I
...
.method public copyFrom(Lcom/android/server/power/DisplayPowerRequest;)V
    ...
    .line 103
    iget-boolean v0, p1, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    iput-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    .line 105
    iget v0, p1, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    iput v0, p0, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    .line 107
    iget v0, p1, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I

    iput v0, p0, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I
...
.method public equals(Lcom/android/server/power/DisplayPowerRequest;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    iget-boolean v1, p1, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    iget v1, p1, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I

    iget v1, p1, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z
    ...
    iget v1, p0, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, ", minAllowedScreenBrightnessOverride="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I
