...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/power/PowerManagerService$ThermalProtectionReceiver;,
...
.field private static final POWER_SAVE_BATTERY_LEVEL:I = 0xf
...
.field private mMinBrightnessOverrideFromWindowManager:I
...
.method public constructor <init>()V
    ...
    .line 264
    iput v1, p0, Lcom/android/server/power/PowerManagerService;->mScreenQuickDimDuration:I
...
.method static synthetic access$2900()Z
    ...
    .prologue
    .line 79
    sget-boolean v0, Lcom/android/server/power/PowerManagerService;->DEBUG_KPI:Z
...
.method static synthetic access$3300(Lcom/android/server/power/PowerManagerService;)I
    ...
    .prologue
    .line 79
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingMaximum:I
...
.method static synthetic access$3400(Lcom/android/server/power/PowerManagerService;)I
    ...
    .prologue
    .line 79
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingMinimum:I

    return v0
.end method

.method static synthetic access$3500(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/DisplayPowerController;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method static synthetic access$3700(Lcom/android/server/power/PowerManagerService;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
...
.method private acquireWakeLockInternal(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;II)V
    ...
    iput-wide v2, v1, Lcom/android/server/power/PowerManagerService$WakeLock;->mTime:J
...
.method private goToSleepNoUpdateLocked(JI)Z
    ...
    invoke-virtual {v5, v6, v7, v8}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private setMinBrightnessOverrideFromWindowManagerInternal(I)V
    .locals 2
    ...
    .line 2462
    :try_start_0
    iget v0, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I

    if-eq v0, p1, :cond_0

    .line 2463
    iput p1, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    .line 1921
    iget v4, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F
    ...
    .line 1923
    iget v2, p0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentOverrideFromWindowManager:F

    .line 1936
    :cond_3
    :goto_4
    iget v4, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I
    ...
    iget v8, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I
    ...
    iget v7, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I

    iput v7, v4, Lcom/android/server/power/DisplayPowerRequest;->minAllowedScreenBrightnessOverride:I
    ...
    iget-boolean v7, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerSaveEnabled:Z
    ...
    :cond_4
    :goto_6
    iput-boolean v5, v4, Lcom/android/server/power/DisplayPowerRequest;->powerSaveEnabled:Z

    .line 1967
    iget v4, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromSetting:I
    ...
    iget v5, p0, Lcom/android/server/power/PowerManagerService;->mButtonBrightnessOverrideFromSetting:I

    iput v5, v4, Lcom/android/server/power/DisplayPowerRequest;->buttonBrightnessOverride:I
...
.method private updateSettingsLocked()V
    ...
    const-string v6, "power_saver_enabled"
    ...
    :goto_6
    iput-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerSaveEnabled:Z
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    iget v9, p0, Lcom/android/server/power/PowerManagerService;->mScreenPreDimDuration:I
    ...
    invoke-virtual {v7, v0, v1, v2}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
    ...
    .line 1595
    iget v7, p0, Lcom/android/server/power/PowerManagerService;->mScreenQuickDimDuration:I
...
.method private wakeUpNoUpdateLocked(J)Z
    ...
    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->mWakeLockMonitor:Ljava/lang/Runnable;
    ...
    iget v0, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mFlags:I
    ...
    .line 1170
    iget-wide v0, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mTime:J
    ...
    .line 1171
    iget-wide v0, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mDurationInSleep:J
    ...
    iput-wide v0, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mDurationInSleep:J
    ...
    iget-wide v9, v7, Lcom/android/server/power/PowerManagerService$WakeLock;->mTime:J
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v9, "  mMinBrightnessOverrideFromWindowManager="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v9, p0, Lcom/android/server/power/PowerManagerService;->mMinBrightnessOverrideFromWindowManager:I
...
.method public setMinBrightnessOverrideFromWindowManager(I)V
    .locals 5
    .param p1, "brightness"    # I
    ...
    .local v0, "ident":J
    :try_start_0
    invoke-direct {p0, p1}, Lcom/android/server/power/PowerManagerService;->setMinBrightnessOverrideFromWindowManagerInternal(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setPreDim(I)V
    ...
    .line 3238
    :try_start_1
    iget v2, p0, Lcom/android/server/power/PowerManagerService;->mScreenPreDimDuration:I
...
.method public setQuickDim(I)V
    ...
    .line 3201
    :try_start_1
    iget v2, p0, Lcom/android/server/power/PowerManagerService;->mScreenQuickDimDuration:I
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    .line 562
    .restart local v14    # "filter":Landroid/content/IntentFilter;
    const-string v2, "com.motorola.action_thermal_protection"
    ...
    new-instance v3, Lcom/android/server/power/PowerManagerService$ThermalProtectionReceiver;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v4}, Lcom/android/server/power/PowerManagerService$ThermalProtectionReceiver;-><init>(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$1;)V
