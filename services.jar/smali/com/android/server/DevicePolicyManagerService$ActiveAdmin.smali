...
.field static final DEF_NFC_AUTHENTICATION_ALLOWED:Z = true
...
.field static final DEF_SKIP_INACTIVITY_TIMEOUT:J
...
.field nfcAuthenticationAllowed:Z
...
.method constructor <init>(Landroid/app/admin/DeviceAdminInfo;)V
    ...
    .line 338
    iput-boolean v1, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->simplePasswordAllowed:Z

    .line 342
    iput v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->disabledKeyguardFeatures:I

    .line 346
    iput-boolean v1, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nfcAuthenticationAllowed:Z

    .line 348
    iput-wide v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->skipInactivityTimeout:J
...
.method dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    .line 618
    iget-boolean v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->simplePasswordAllowed:Z
    ...
    const-string v2, "nfcAuthenticationAllowed="

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    .line 621
    iget-boolean v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nfcAuthenticationAllowed:Z
    ...
    const-string v2, "skipInactivityTimeout="

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    .line 623
    iget-wide v2, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->skipInactivityTimeout:J
...
.method readFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->simplePasswordAllowed:Z

    goto/16 :goto_1

    .line 565
    :cond_16
    const-string v3, "nfc-auth-allowed"
    ...
    iput-boolean v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nfcAuthenticationAllowed:Z

    goto/16 :goto_1

    .line 568
    :cond_17
    const-string v3, "skip-inactivity-timeout"
    ...
    iput-wide v3, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->skipInactivityTimeout:J
...
.method writeToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    .line 419
    :cond_7
    iget-boolean v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->simplePasswordAllowed:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->simplePasswordAllowed:Z
    ...
    .line 427
    :cond_8
    iget-boolean v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nfcAuthenticationAllowed:Z

    if-eq v0, v2, :cond_9

    .line 428
    const-string v0, "nfc-auth-allowed"
    ...
    iget-boolean v1, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->nfcAuthenticationAllowed:Z
    ...
    .line 432
    :cond_9
    iget-wide v0, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->skipInactivityTimeout:J
    ...
    .line 433
    const-string v0, "skip-inactivity-timeout"
    ...
    iget-wide v1, p0, Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;->skipInactivityTimeout:J
