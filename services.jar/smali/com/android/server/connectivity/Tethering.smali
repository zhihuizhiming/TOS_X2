...
# instance fields
.field private mAllTypes:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    .line 146
    iput-object v7, p0, Lcom/android/server/connectivity/Tethering;->mAllTypes:Ljava/util/ArrayList;
...
.method static synthetic access$4600(Lcom/android/server/connectivity/Tethering;)V
    ...
    .prologue
    .line 85
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->checkApnConfigured()V

    return-void
.end method

.method static synthetic access$4700(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method private checkApnConfigured()V
    .locals 5

    .prologue
    .line 1776
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->createAllTypeList()V

    .line 1777
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->isDunRequired()Z
    ...
    .line 1778
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->keepDunUpstream()V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/connectivity/Tethering;->getConfiguredApnType(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_2

    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->fetchDunApn()Z
    ...
    const-string v3, " upstream interface types:"
...
.method private createAllTypeList()V
    .locals 7
    ...
    iput-object v0, p0, Lcom/android/server/connectivity/Tethering;->mAllTypes:Ljava/util/ArrayList;
    ...
    .line 1841
    invoke-direct {p0, v6}, Lcom/android/server/connectivity/Tethering;->createTypeList(Landroid/database/Cursor;)Ljava/util/ArrayList;
...
.method private createTypeList(Landroid/database/Cursor;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-direct {p0, v2}, Lcom/android/server/connectivity/Tethering;->parseTypes(Ljava/lang/String;)[Ljava/lang/String;
...
.method private fetchDunApn()Z
    ...
    .line 1879
    .local v1, "dunSetting":Lcom/android/internal/telephony/dataconnection/ApnSetting;
    if-eqz v1, :cond_1
...
.method private getConfiguredApnType(Ljava/lang/String;)Z
    .locals 9
    ...
    .line 1813
    iget-object v7, p0, Lcom/android/server/connectivity/Tethering;->mAllTypes:Ljava/util/ArrayList;
...
.method private isDunRequired()Z
    .locals 6
    ...
    .line 1896
    :cond_1
    const-string v4, "ro.mot.tether_dun_required"
...
.method private keepDunUpstream()V
    .locals 2
...
.method public checkDunRequired()V
    ...
    const-string v6, "tether_dun_required"
    ...
    .line 693
    .restart local v2    # "requiredApn":I
    :cond_1
    :goto_1
    :try_start_1
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mUpstreamIfaceTypes:Ljava/util/Collection;
    ...
    const-string v6, " upstream interface types:"
...
.method public setUsbTethering(Z)I
    ...
    invoke-static {v1, p1}, Lcom/motorola/tether/entitlement/EntitlementCheck;->isEntitledForUsbTethering(Landroid/content/Context;Z)Z
