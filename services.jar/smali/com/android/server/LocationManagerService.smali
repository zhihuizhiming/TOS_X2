...
.method static synthetic access$1700(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationBackgroundHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1702(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$LocationBackgroundHandler;)Lcom/android/server/LocationManagerService$LocationBackgroundHandler;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    .line 2172
    sget-boolean v31, Lcom/android/server/LocationManagerService;->mBuildTypeUser:Z
...
.method private loadProvidersLocked()V
    ...
    iget-object v4, v0, Lcom/android/server/LocationManagerService;->mBlacklist:Lcom/android/server/location/LocationBlacklist;

    invoke-direct {v2, v3, v4}, Lcom/android/server/location/GeofenceManager;-><init>(Landroid/content/Context;Lcom/android/server/location/LocationBlacklist;)V
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    .line 1634
    :cond_0
    invoke-virtual {p1, v7}, Lcom/android/server/LocationManagerService$Receiver;->updateMonitoring(Z)V
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    const-string v3, "provider name must not be null"
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/LocationManagerService$UpdateRecord;-><init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;Ljava/lang/String;)V
    ...
    .line 1582
    .local v7, "oldRecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    if-eqz v7, :cond_3

    .line 1583
    invoke-virtual {v7, v9}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V
...
.method public removeGeofence(Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/location/GeoFencerBase;->remove(DDFLandroid/app/PendingIntent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Landroid/location/Geofence;->getRadius()F
...
.method public systemRunning()V
    ...
    sput-wide v8, Lcom/android/server/LocationManagerService;->mLogInterval:J
    ...
    invoke-direct {v2, p0, v5}, Lcom/android/server/LocationManagerService$LocationBackgroundThread;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V

    const-string v5, "LocationBackgroundThread"

    invoke-direct {v7, v0, v2, v5}, Ljava/lang/Thread;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;)V
