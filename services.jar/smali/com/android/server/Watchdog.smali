...
.method public run()V
    ...
    check-cast v13, Lcom/android/server/Watchdog$HandlerChecker;

    .line 347
    .local v13, "hc":Lcom/android/server/Watchdog$HandlerChecker;
    invoke-virtual {v13}, Lcom/android/server/Watchdog$HandlerChecker;->scheduleCheckLocked()V
    ...
    .line 354
    .end local v13    # "hc":Lcom/android/server/Watchdog$HandlerChecker;
    :cond_0
    ...
    invoke-static {v0, v11}, Landroid/util/Log;->wtf(Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v37, "com.android.defcontainer"

    aput-object v37, v9, v36

    .line 401
    .local v9, "defcontainerProcess":[Ljava/lang/String;
    invoke-static {v9}, Landroid/os/Process;->getPidsForCommands([Ljava/lang/String;)[I

    move-result-object v21

    .line 402
    .local v21, "pidArray":[I
    if-eqz v21, :cond_7
