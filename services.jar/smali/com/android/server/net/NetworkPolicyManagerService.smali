...
.method static synthetic access$1500(Lcom/android/server/net/NetworkPolicyManagerService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/net/NetworkPolicyManagerService;
...
.method static synthetic access$1702(Lcom/android/server/net/NetworkPolicyManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/net/NetworkPolicyManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$2100(Lcom/android/server/net/NetworkPolicyManagerService;Landroid/content/Intent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/net/NetworkPolicyManagerService;
...
.method private applyVoicePriorityRule()V
    ...
    const-string v2, "mBlockAllDataTraffic:"
    ...
    const-string v2, ";mIsBgDataRestrictedInVoice:"
    ...
    const-string v2, ";mIsTetherActive:"
    ...
    iget-boolean v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsMobileDataConnected:Z
...
.method private updateRulesForUidLocked(I)V
    ...
    iget-object v5, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsBgDataRestrictedInVoice:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v7, ";mRestrictBackground:"
    ...
    const-string v7, ";mIsBgDataRestrictedInVoice"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mIsBgDataRestrictedInVoice:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public systemReady()V
    ...
    iget-object v13, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mProcessObserver:Landroid/app/IProcessObserver;

    invoke-interface {v12, v13}, Landroid/app/IActivityManager;->registerProcessObserver(Landroid/app/IProcessObserver;)V
    ...
    invoke-virtual {v12, v13, v3, v14, v15}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    const-string v12, "android.intent.action.ACTION_NETWORK_COVERAGE_CHANGE"

    invoke-direct {v2, v12}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 426
    .local v2, "bgDataInVoiceFilter":Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-object v13, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mBgDataInVoiceReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-boolean v12, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mBlockAllDataTraffic:Z
    ...
    invoke-direct {v8, v12}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 434
    .local v8, "tetherStateFilter":Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-object v13, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mTetherStateReceiver:Landroid/content/BroadcastReceiver;
    ...
    .end local v2    # "bgDataInVoiceFilter":Landroid/content/IntentFilter;
    ...
    .end local v8    # "tetherStateFilter":Landroid/content/IntentFilter;
