...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 276
    iput v9, p0, Lcom/android/server/location/GpsLocationProvider;->mSilentCnt:I

    .line 291
    iput v9, p0, Lcom/android/server/location/GpsLocationProvider;->mInitializeRetry:I
    ...
    iput v6, p0, Lcom/android/server/location/GpsLocationProvider;->mEngineLock:I

    .line 295
    iput-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mSetLockAllowed:Z
    ...
    iput-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mInitializeNvItems:Ljava/lang/Runnable;
    ...
    iput-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mMvmtMonIntent:Landroid/app/PendingIntent;
    ...
    :cond_1
    :goto_1
    const-string v6, "persist.mot.gps.smart_battery"
    ...
    const-string v7, "MovementMonitor disabled"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 607
    :cond_2
    iput-object v11, p0, Lcom/android/server/location/GpsLocationProvider;->mMvmtMon:Lcom/android/server/location/GpsLocationProvider$MovementMonitor;
    ...
    check-cast v2, Lcom/motorola/slpc/ModalityManager;

    .line 611
    .local v2, "mm":Lcom/motorola/slpc/ModalityManager;
    if-nez v2, :cond_5

    .line 612
    const-string v6, "GpsLocationProvider"

    const-string v7, "Modality service not found"
    ...
    .line 615
    :cond_5
    new-instance v6, Lcom/android/server/location/GpsLocationProvider$MovementMonitor;

    invoke-direct {v6, p0, v2}, Lcom/android/server/location/GpsLocationProvider$MovementMonitor;-><init>(Lcom/android/server/location/GpsLocationProvider;Lcom/motorola/slpc/ModalityManager;)V

    iput-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mMvmtMon:Lcom/android/server/location/GpsLocationProvider$MovementMonitor;
    ...
    const-string v7, "MovementMonitor created"
...
.method static synthetic access$2000(Lcom/android/server/location/GpsLocationProvider;ILjava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
...
.method static synthetic access$2100(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4600(Lcom/android/server/location/GpsLocationProvider;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4700(Lcom/android/server/location/GpsLocationProvider;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4800(Lcom/android/server/location/GpsLocationProvider;ZZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$5002(Lcom/android/server/location/GpsLocationProvider;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # Z
...
.method static synthetic access$5100(Lcom/android/server/location/GpsLocationProvider;)Landroid/location/Location;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5200(Lcom/android/server/location/GpsLocationProvider;)Landroid/location/ILocationManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5300(Lcom/android/server/location/GpsLocationProvider;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5302(Lcom/android/server/location/GpsLocationProvider;J)J
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # J
...
.method static synthetic access$6100(Lcom/android/server/location/GpsLocationProvider;ILandroid/app/PendingIntent;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
    .param p2, "x2"    # Landroid/app/PendingIntent;
...
.method private hibernate_Locked(ILandroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v4, v5, v6, p2}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
...
.method private listenForBroadcasts()V
    ...
    .line 671
    const-string v2, "com.android.internal.location.ALARM_MVMT_MON"
...
.method private reportLocation(IDDDFFFJ)V
    ...
    const-string v9, " accuracy_valid: "
...
.method private reportStatus(I)V
    ...
    const-string v5, "reportStatus status: "
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/server/location/GpsLocationProvider;->provideStatus(ZZ)V
    ...
    const-string v5, "GPS_STATUS_SESSION_BEGIN"
    ...
    .line 1559
    :cond_4
    iget v3, p0, Lcom/android/server/location/GpsLocationProvider;->mSilentCnt:I
    ...
    .end local v1    # "skipStatus":Z
    .end local v2    # "wasNavigating":Z
    :catchall_0
    move-exception v3
    ...
    .restart local v1    # "skipStatus":Z
    .restart local v2    # "wasNavigating":Z
    :pswitch_1
    :try_start_1
    sget-boolean v3, Lcom/android/server/location/GpsLocationProvider;->DEBUG:Z
    ...
    const-string v5, "GPS_STATUS_SESSION_END"
    ...
    const-string v5, "GPS_STATUS_ENGINE_ON"
    ...
    const-string v5, "GPS_STATUS_ENGINE_OFF"
...
.method private startNavigating_Locked(ZZ)V
    ...
    invoke-virtual {v0, v9}, Lcom/android/server/location/GpsLocationProvider$MovementMonitor;->setNoFixAlarm(I)V
