...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/media/AudioService$KeyEventOverride;,
        ...
        Landroid/media/AudioService$MyOrientationEventListener;
    }
.end annotation
...
.field private static final MSG_PERSIST_SAFE_VOLUME_TIMER:I = 0x15
...
.field private static final MUSIC_SAFE_VOLUME_TIMER_POLLS_PER_PERSIST:I = 0x3c
...
.field private static final VOLUME_UI_PERMISSION:Ljava/lang/String; = "com.motorola.permission.VOLUME_SETTING"
...
.field private final TTY_ENABLED_CHANGE_ACTION:Ljava/lang/String;

.field private final TTY_MODE_FULL:I

.field private final TTY_MODE_HCO:I

.field private final TTY_MODE_OFF:I

.field private final TTY_MODE_VCO:I

.field private mA2dp:Landroid/bluetooth/BluetoothA2dp;

.field private final mA2dpAvrcpLock:Ljava/lang/Object;

.field private mA2dpIsCarkit:Z
...
.field private mKeyEventOverride:Landroid/media/AudioService$KeyEventOverride;

.field private final mKeyEventOverrideLock:Ljava/lang/Object;
...
.field private mMusicSafePoll:I

.field private mMuteAffectedStreams:I

.field private mOrientationListener:Landroid/media/AudioService$MyOrientationEventListener;

.field private mPendingVolumeCommand:Landroid/media/AudioService$StreamVolumeCommand;

.field private mPersistedLastMusicMs:I
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/media/AudioService;->DBG:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v1, "STREAM_INCALL_MUSIC"
    ...
    iput-object v0, p0, Landroid/media/AudioService;->TTY_ENABLED_CHANGE_ACTION:Ljava/lang/String;

    .line 454
    iput v6, p0, Landroid/media/AudioService;->TTY_MODE_OFF:I

    .line 455
    iput v11, p0, Landroid/media/AudioService;->TTY_MODE_FULL:I

    .line 456
    iput v2, p0, Landroid/media/AudioService;->TTY_MODE_HCO:I

    .line 457
    const/4 v0, 0x3

    iput v0, p0, Landroid/media/AudioService;->TTY_MODE_VCO:I
    ...
    iput-object v0, p0, Landroid/media/AudioService;->mKeyEventOverrideLock:Ljava/lang/Object;
    ...
    .line 500
    iput-boolean v6, p0, Landroid/media/AudioService;->mIsInitialized:Z
    ...
    .line 4808
    iput v6, p0, Landroid/media/AudioService;->mMusicSafePoll:I

    .line 4809
    iput v6, p0, Landroid/media/AudioService;->mPersistedLastMusicMs:I
    ...
    .line 530
    iput-boolean v6, p0, Landroid/media/AudioService;->mA2dpIsCarkit:Z
    ...
    .line 603
    new-instance v0, Landroid/media/AudioService$MyOrientationEventListener;

    iget-object v1, p0, Landroid/media/AudioService;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1}, Landroid/media/AudioService$MyOrientationEventListener;-><init>(Landroid/media/AudioService;Landroid/content/Context;)V

    iput-object v0, p0, Landroid/media/AudioService;->mOrientationListener:Landroid/media/AudioService$MyOrientationEventListener;

    .line 604
    iget-object v0, p0, Landroid/media/AudioService;->mOrientationListener:Landroid/media/AudioService$MyOrientationEventListener;

    invoke-virtual {v0}, Landroid/media/AudioService$MyOrientationEventListener;->enable()V
    ...
    .line 621
    new-instance v0, Landroid/media/AudioService$KeyEventOverride;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1, v6}, Ljava/util/HashSet;-><init>(I)V

    invoke-direct {v0, p0, v5, v5, v1}, Landroid/media/AudioService$KeyEventOverride;-><init>(Landroid/media/AudioService;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)V

    iput-object v0, p0, Landroid/media/AudioService;->mKeyEventOverride:Landroid/media/AudioService$KeyEventOverride;

    .line 623
    iput-boolean v11, p0, Landroid/media/AudioService;->mIsInitialized:Z
...
.method static synthetic access$3602(Landroid/media/AudioService;I)I
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # I
...
.method static synthetic access$4000(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$5600(Landroid/media/AudioService;)Z
    ...
    .prologue
    .line 121
    iget-boolean v0, p0, Landroid/media/AudioService;->mIsInitialized:Z
...
.method static synthetic access$6800(Landroid/media/AudioService;)Z
    ...
    .prologue
    .line 121
    iget-boolean v0, p0, Landroid/media/AudioService;->mA2dpIsCarkit:Z
...
.method static synthetic access$7700(Landroid/media/AudioService;I)V
    ...
    .prologue
    .line 121
    invoke-direct {p0, p1}, Landroid/media/AudioService;->onPersistSafeVolumeTimer(I)V
...
.method static synthetic access$8500(Landroid/media/AudioService;)Landroid/media/AudioService$MyOrientationEventListener;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$8900(Landroid/media/AudioService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 121
    invoke-direct {p0, p1, p2}, Landroid/media/AudioService;->setCustomVolumeUIInternal(Ljava/lang/String;Ljava/lang/String;)V
...
.method private handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    invoke-static {p2, v1, v0}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
    ...
    iget v3, p0, Landroid/media/AudioService;->mMusicActiveMs:I
    ...
    invoke-static {p2, v0, p3}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
...
.method private makeA2dpDeviceUnavailableLater(Ljava/lang/String;)V
    ...
    .line 3974
    iput-boolean v3, p0, Landroid/media/AudioService;->mA2dpIsCarkit:Z
...
.method private makeA2dpDeviceUnavailableNow(Ljava/lang/String;)V
    ...
    .line 3959
    iput-boolean v2, p0, Landroid/media/AudioService;->mA2dpIsCarkit:Z
...
.method private onCheckMusicActive()V
    ...
    .line 2545
    :cond_0
    iget v0, p0, Landroid/media/AudioService;->mMusicSafePoll:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Landroid/media/AudioService;->mMusicSafePoll:I
    ...
    iput v0, p0, Landroid/media/AudioService;->mMusicSafePoll:I
...
.method private onConfigureSafeVolume(Z)V
    ...
    .line 2580
    .restart local v8    # "persistedState":I
    const/4 v0, 0x1
...
.method private onPersistSafeVolumeTimer(I)V
    .locals 2
    .param p1, "timer"    # I

    .prologue
    .line 3889
    iget v0, p0, Landroid/media/AudioService;->mPersistedLastMusicMs:I
    ...
    const-string/jumbo v1, "music_active_ms"

    invoke-static {v0, v1, p1}, Lcom/motorola/android/provider/MotorolaSettings$Global;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    .line 3892
    iput p1, p0, Landroid/media/AudioService;->mPersistedLastMusicMs:I
...
.method private onSetA2dpConnectionState(Landroid/bluetooth/BluetoothDevice;I)V
    ...
    const-string v2, " announces class "
    ...
    iput-boolean v0, p0, Landroid/media/AudioService;->mA2dpIsCarkit:Z
    ...
    .line 4052
    .restart local v8    # "btClass":Landroid/bluetooth/BluetoothClass;
    :cond_c
    const-string v0, "AudioService"
    ...
    const-string v2, " has no class information"
...
.method private readPersistedSettings()V
    ...
    const-string/jumbo v6, "music_active_ms"

    invoke-static {v4, v6, v5}, Lcom/motorola/android/provider/MotorolaSettings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Landroid/media/AudioService;->mMusicActiveMs:I
...
.method private setCustomVolumeUIInternal(Ljava/lang/String;Ljava/lang/String;)V
    .locals 10
    ...
    .line 5050
    .local v5, "viewFactory":Ljava/lang/Object;
    const-string v6, "getVolumePanel"
    ...
    const-class v9, Landroid/media/AudioService;
    ...
    check-cast v3, Landroid/view/VolumePanel;

    .line 5054
    .local v3, "newPanel":Landroid/view/VolumePanel;
    if-eqz v3, :cond_0

    .line 5055
    invoke-direct {p0, v3}, Landroid/media/AudioService;->setVolumePanel(Landroid/view/VolumePanel;)V
    :try_end_1
    ...
    .end local v3    # "newPanel":Landroid/view/VolumePanel;
    .end local v5    # "viewFactory":Ljava/lang/Object;
    :goto_0
    return-void
    ...
    .restart local v1    # "factoryClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .restart local v2    # "method":Ljava/lang/reflect/Method;
    .restart local v3    # "newPanel":Landroid/view/VolumePanel;
    .restart local v5    # "viewFactory":Ljava/lang/Object;
    :cond_0
    :try_start_2
    const-string v6, "AudioService"

    const-string v7, "Failed to obtain new volume UI"
    ...
    const-string v7, "Failed to instantiate volume UI"
...
.method private setVolumePanel(Landroid/view/VolumePanel;)V
    .locals 2
    .param p1, "volumePanel"    # Landroid/view/VolumePanel;
    ...
    invoke-virtual {v0}, Landroid/view/VolumePanel;->release()V
    ...
    invoke-virtual {v0, v1}, Landroid/media/MediaFocusControl;->setVolumeController(Landroid/media/VolumeController;)V
...
.method public getOverrideKeyEventsComponent(I)Landroid/content/ComponentName;
    ...
    .prologue
    .line 5110
    iget-object v1, p0, Landroid/media/AudioService;->mKeyEventOverrideLock:Ljava/lang/Object;

    monitor-enter v1

    .line 5111
    :try_start_0
    iget-object v0, p0, Landroid/media/AudioService;->mKeyEventOverride:Landroid/media/AudioService$KeyEventOverride;

    invoke-virtual {p0, p1}, Landroid/media/AudioService;->getEffectiveStreamType(I)I

    move-result v2

    invoke-virtual {v0, v2}, Landroid/media/AudioService$KeyEventOverride;->overridesStream(I)Z
    ...
    invoke-virtual {v0}, Landroid/media/AudioService$KeyEventOverride;->getComponent()Landroid/content/ComponentName;
...
.method public isVolumePanelShowing()Z
    ...
    invoke-virtual {v0}, Landroid/view/VolumePanel;->isDialogShowing()Z
...
.method public overrideKeyEvents(Ljava/lang/String;Ljava/lang/String;[I)V
    ...
    const-string v6, "com.motorola.permission.VOLUME_SETTING"
    ...
    const-string/jumbo v6, "overrideKeyEvents(): permission check failed"
    ...
    .line 5100
    .local v4, "streamSet":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    move-object v0, p3
    ...
    :cond_1
    iget-object v6, p0, Landroid/media/AudioService;->mKeyEventOverrideLock:Ljava/lang/Object;

    monitor-enter v6

    .line 5104
    :try_start_0
    new-instance v5, Landroid/media/AudioService$KeyEventOverride;

    invoke-direct {v5, p0, p1, p2, v4}, Landroid/media/AudioService$KeyEventOverride;-><init>(Landroid/media/AudioService;Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;)V

    iput-object v5, p0, Landroid/media/AudioService;->mKeyEventOverride:Landroid/media/AudioService$KeyEventOverride;
...
.method public setCustomVolumeUI(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "com.motorola.permission.VOLUME_SETTING"
    ...
    const-string/jumbo v1, "setCustomVolumeUI(): permission check failed"
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/media/AudioService$3;-><init>(Landroid/media/AudioService;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setMode(ILandroid/os/IBinder;)V
    ...
    .line 1662
    :cond_2
    sget-boolean v1, Landroid/media/AudioService;->DBG:Z
...
.method setModeInt(ILandroid/os/IBinder;I)I
    ...
    .line 1733
    sget-boolean v12, Landroid/media/AudioService;->DBG:Z
    ...
    const-string v14, "AudioSystem.setPhoneState("
...
.method public showVolumePanel(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/view/VolumePanel;->postShow(I)V
