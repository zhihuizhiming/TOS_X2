...
.method private doNxpHack()V
    ...
    .line 4244
    new-instance v2, Landroid/media/AudioService$AudioServiceBroadcastReceiver$1;

    invoke-direct {v2, p0}, Landroid/media/AudioService$AudioServiceBroadcastReceiver$1;-><init>(Landroid/media/AudioService$AudioServiceBroadcastReceiver;)V

    invoke-virtual {v1, v2}, Landroid/media/MediaPlayer;->setOnCompletionListener(Landroid/media/MediaPlayer$OnCompletionListener;)V

    .line 4252
    new-instance v2, Landroid/media/AudioService$AudioServiceBroadcastReceiver$2;

    invoke-direct {v2, p0}, Landroid/media/AudioService$AudioServiceBroadcastReceiver$2;-><init>(Landroid/media/AudioService$AudioServiceBroadcastReceiver;)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 4355
    .restart local v22    # "params":Ljava/lang/String;
    :cond_9
    const/16 v20, 0x4000
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$4000(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$4902(Landroid/media/AudioService;Z)Z
    ...
    .line 4460
    invoke-direct/range {p0 .. p0}, Landroid/media/AudioService$AudioServiceBroadcastReceiver;->doNxpHack()V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$6400(Landroid/media/AudioService;)Z
    ...
    # getter for: Landroid/media/AudioService;->mOrientationListener:Landroid/media/AudioService$MyOrientationEventListener;
    invoke-static {v3}, Landroid/media/AudioService;->access$8500(Landroid/media/AudioService;)Landroid/media/AudioService$MyOrientationEventListener;

    move-result-object v3

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Landroid/media/AudioService$MyOrientationEventListener;->onOrientationChanged(I)V
    ...
    invoke-virtual {v3}, Landroid/media/AudioService$MyOrientationEventListener;->enable()V
    ...
    invoke-virtual {v3}, Landroid/media/AudioService$MyOrientationEventListener;->disable()V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$4900(Landroid/media/AudioService;)Z
