...
.field public static final EXTRA_KEY_EVENT:Ljava/lang/String; = "motorola.android.media.EXTRA_KEY_EVENT"
...
.field public static final VOLUME_KEY_ACTION:Ljava/lang/String; = "motorola.android.media.VOLUME_KEY_ACTION"
...
.method private overrideHandleKeyEvent(Landroid/view/KeyEvent;I)Z
    .locals 7
    .param p1, "event"    # Landroid/view/KeyEvent;
    .param p2, "controlStream"    # I
    ...
    :try_start_0
    invoke-interface {v3, p2}, Landroid/media/IAudioService;->getOverrideKeyEventsComponent(I)Landroid/content/ComponentName;
    :try_end_0
    ...
    const-string v6, "Dead object in overrideHandleKeyEvent"
    ...
    const-string/jumbo v6, "motorola.android.media.VOLUME_KEY_ACTION"

    invoke-direct {v5, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v6, "motorola.android.media.EXTRA_KEY_EVENT"
...
.method public getEffectiveStreamType(I)I
    ...
    .local v1, "service":Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->getEffectiveStreamType(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in getActiveStreamType"
...
.method public handleKeyDown(Landroid/view/KeyEvent;I)V
    ...
    .line 560
    invoke-direct {p0, p1, p2}, Landroid/media/AudioManager;->overrideHandleKeyEvent(Landroid/view/KeyEvent;I)Z
...
.method public isVolumePanelShowing()Z
    ...
    invoke-interface {v1}, Landroid/media/IAudioService;->isVolumePanelShowing()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in isVolumePanelShowing "
...
.method public overrideKeyEvents(Ljava/lang/String;Ljava/lang/String;[I)V
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/media/IAudioService;->overrideKeyEvents(Ljava/lang/String;Ljava/lang/String;[I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in overrideKeyEvents "
...
.method public setCustomVolumeUI(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/media/IAudioService;->setCustomVolumeUI(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setCustomVolumeUI "
...
.method public showVolumePanel(I)V
    ...
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->showVolumePanel(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in showVolumePanel "
