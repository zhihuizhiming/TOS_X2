...
.method public static compareLoosely(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 478
    .local v17, "numNonDialableCharsInA":I
    const/16 v18, 0x0

    .line 483
    .local v18, "numNonDialableCharsInB":I
    if-eqz p0, :cond_0
    ...
    .line 492
    :cond_4
    const-string v20, "gsm.sim.max.match"
    ...
    .line 493
    .local v14, "maxMatchProp":Ljava/lang/String;
    ...
    .line 501
    .local v13, "maxMatch":I
    :goto_1
    const-string v20, "gsm.sim.min.match"
    ...
    .line 502
    .local v16, "minMatchProp":Ljava/lang/String;
    ...
    .end local v13    # "maxMatch":I
    .end local v15    # "minMatch":I
    .end local v16    # "minMatchProp":Ljava/lang/String;
    :cond_7
    const/4 v13, 0x0

    .restart local v13    # "maxMatch":I
    goto :goto_1

    .line 505
    .restart local v16    # "minMatchProp":Ljava/lang/String;
    :cond_8
    const/4 v15, 0x7

    .restart local v15    # "minMatch":I
    goto :goto_2

    .line 526
    .restart local v10    # "ia":I
    .restart local v11    # "ib":I
    .restart local v12    # "matched":I
    .restart local v19    # "skipCmp":Z
    :cond_9
    move-object/from16 v0, p0
    ...
    .end local v7    # "cb":C
    .end local v19    # "skipCmp":Z
    .restart local v8    # "effectiveALen":I
    .restart local v9    # "effectiveBLen":I
    :cond_d
    const/16 v20, 0x0
...
.method public static getN11Name(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    .locals 6
    .param p0, "context"    # Landroid/content/Context;
    ...
    .line 1677
    .local v1, "N11Number":[Ljava/lang/String;
    invoke-virtual {p0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;
...
.method public static isN11Number(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 5
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "number"    # Ljava/lang/String;
    ...
    .line 1663
    .local v0, "N11Number":[Ljava/lang/String;
    const/4 v1, 0x0
