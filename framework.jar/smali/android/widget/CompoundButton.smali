...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    check-cast v1, Landroid/widget/CompoundButton$SavedState;
    ...
    iget v4, v1, Landroid/widget/CompoundButton$SavedState;->localeHashCode:I
    ...
    instance-of v4, v2, Landroid/widget/TextView$SavedState;
    ...
    .line 406
    .local v3, "txss":Landroid/widget/TextView$SavedState;
    const/4 v4, 0x0

    iput-object v4, v3, Landroid/widget/TextView$SavedState;->text:Ljava/lang/CharSequence;

    .line 410
    .end local v2    # "superState":Landroid/os/Parcelable;
    .end local v3    # "txss":Landroid/widget/TextView$SavedState;
    :cond_0
    invoke-virtual {v1}, Landroid/widget/CompoundButton$SavedState;->getSuperState()Landroid/os/Parcelable;

    move-result-object v4

    invoke-super {p0, v4}, Landroid/widget/Button;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 411
    iget-boolean v4, v1, Landroid/widget/CompoundButton$SavedState;->checked:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v3}, Landroid/widget/CompoundButton;->setFreezesText(Z)V
    ...
    invoke-direct {v1, v2}, Landroid/widget/CompoundButton$SavedState;-><init>(Landroid/os/Parcelable;)V
    ...
    iput-boolean v3, v1, Landroid/widget/CompoundButton$SavedState;->checked:Z
    ...
    iput v3, v1, Landroid/widget/CompoundButton$SavedState;->localeHashCode:I
