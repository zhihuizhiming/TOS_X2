...
.field public static final PASSWORD_QUALITY_FINGERPRINT:I = 0x30000

.field public static final PASSWORD_QUALITY_NFC_RING:I = 0x25000

.field public static final PASSWORD_QUALITY_NFC_RING_DEPRECATED:I = 0x70000

.field public static final PASSWORD_QUALITY_NFC_RING_DEPRECATED1:I = 0x15000
...
.method public getNfcAllowed(Landroid/content/ComponentName;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/admin/DevicePolicyManager;->getNfcAllowed(Landroid/content/ComponentName;I)Z
...
.method public getNfcAllowed(Landroid/content/ComponentName;I)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->getNfcAllowed(Landroid/content/ComponentName;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getSkipInactivityTimeout(Landroid/content/ComponentName;)J
    .locals 2
    .param p1, "admin"    # Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/app/admin/DevicePolicyManager;->getSkipInactivityTimeout(Landroid/content/ComponentName;I)J
...
.method public getSkipInactivityTimeout(Landroid/content/ComponentName;I)J
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->getSkipInactivityTimeout(Landroid/content/ComponentName;I)J
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isFingerprintSufficient()Z
    .locals 3
    ...
    invoke-interface {v1, v2}, Landroid/app/admin/IDevicePolicyManager;->isFingerprintSufficient(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isNDigitPinSufficient(I)Z
    .locals 3
    .param p1, "length"    # I
    ...
    invoke-interface {v1, p1, v2}, Landroid/app/admin/IDevicePolicyManager;->isNDigitPinSufficient(II)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setActivePasswordStateReusingExisting(II)V
    ...
    invoke-interface {v1, p1, p2}, Landroid/app/admin/IDevicePolicyManager;->setActivePasswordStateReusingExisting(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setActivePasswordStateUsingBackup(IIIIIIIIIZI)V
    ...
    invoke-interface/range {v0 .. v11}, Landroid/app/admin/IDevicePolicyManager;->setActivePasswordStateUsingBackup(IIIIIIIIIZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setNfcQuality(Landroid/content/ComponentName;Z)V
    .locals 3
    .param p1, "who"    # Landroid/content/ComponentName;
    ...
    invoke-interface {v1, p1, p2, v2}, Landroid/app/admin/IDevicePolicyManager;->setNfcQuality(Landroid/content/ComponentName;ZI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSkipInactivityTimeout(Landroid/content/ComponentName;J)V
    .locals 3
    .param p1, "admin"    # Landroid/content/ComponentName;
    .param p2, "timeout"    # J
    ...
    invoke-interface {v1, p1, p2, p3, v2}, Landroid/app/admin/IDevicePolicyManager;->setSkipInactivityTimeout(Landroid/content/ComponentName;JI)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
