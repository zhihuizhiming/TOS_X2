...
.method public execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/Instrumentation$ActivityResult;
    ...
    .line 1427
    .local v25, "devicePolicyManager":Landroid/app/admin/DevicePolicyManager;
    invoke-virtual/range {v25 .. v25}, Landroid/app/admin/DevicePolicyManager;->getAovGoogleNowComponentName()Landroid/content/ComponentName;

    move-result-object v28

    .line 1428
    .local v28, "searchActivity":Landroid/content/ComponentName;
    if-eqz p1, :cond_0
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/app/admin/DevicePolicyManager;->isAovBypassKeyguardGoogleNowEnabled()Z
    ...
    invoke-interface/range {v29 .. v29}, Landroid/view/IWindowManager;->isKeyguardLocked()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface/range {v29 .. v29}, Landroid/view/IWindowManager;->isKeyguardSecure()Z
    ...
    check-cast v24, Landroid/app/Instrumentation$ActivityMonitor;

    .line 1473
    .local v24, "am":Landroid/app/Instrumentation$ActivityMonitor;
    const/4 v3, 0x0
    ...
    .line 1475
    invoke-virtual/range {v24 .. v24}, Landroid/app/Instrumentation$ActivityMonitor;->isBlocking()Z
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/app/Instrumentation$ActivityMonitor;->getResult()Landroid/app/Instrumentation$ActivityResult;
    ...
    .line 1481
    .end local v23    # "N":I
    .end local v24    # "am":Landroid/app/Instrumentation$ActivityMonitor;
    .end local v26    # "i":I
    :catchall_0
    move-exception v3
    ...
    .restart local v24    # "am":Landroid/app/Instrumentation$ActivityMonitor;
    ...
    invoke-interface/range {v11 .. v22}, Landroid/app/IActivityManager;->startActivity(Landroid/app/IApplicationThread;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/os/Bundle;)I
    ...
    .restart local v29    # "wm":Landroid/view/IWindowManager;
    :catch_1
    move-exception v3
