...
.method public enter()V
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mWifiScanMovementListener:Landroid/net/wifi/MotWifiScanMovementListener;
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$8700(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/MotWifiScanMovementListener;

    move-result-object v0

    invoke-virtual {v0}, Landroid/net/wifi/MotWifiScanMovementListener;->unregisterSensorHubMovement()V

    .line 3451
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$SupplicantStoppingState;->this$0:Landroid/net/wifi/WifiStateMachine;

    # getter for: Landroid/net/wifi/WifiStateMachine;->mDhcpStateMachine:Landroid/net/DhcpStateMachine;
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$3800(Landroid/net/wifi/WifiStateMachine;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$6000(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiMonitor;
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiStateMachine;->access$6100(Landroid/net/wifi/WifiStateMachine;I)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$11700(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->loge(Ljava/lang/String;)V
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$11800(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
