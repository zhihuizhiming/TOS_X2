...
.method private updateLinkProperitesAndCapatilities(Landroid/content/Intent;)V
    ...
    iput-object v2, p0, Landroid/net/MobileDataStateTracker;->mLinkProperties:Landroid/net/LinkProperties;
    ...
    .line 205
    const-string v2, "CONNECTED event did not supply link properties."
    ...
    invoke-virtual {v2}, Landroid/net/LinkProperties;->hasIPv6Address()Z
    ...
    invoke-virtual {v2, v1, v0}, Landroid/net/LinkProperties;->validMtu(IZ)Z
    ...
    .line 221
    const-string v2, "Using FW overlay value config_mobile_mtu"
    ...
    iput-object v2, p0, Landroid/net/MobileDataStateTracker;->mLinkCapabilities:Landroid/net/LinkCapabilities;

    .line 229
    iget-object v2, p0, Landroid/net/MobileDataStateTracker;->mLinkCapabilities:Landroid/net/LinkCapabilities;

    if-nez v2, :cond_2

    .line 230
    const-string v2, "CONNECTED event did not supply link capabilities."
    ...
    const-string v3, "Obtained mtu from telephony is: "
    ...
    invoke-virtual {v2, v1}, Landroid/net/LinkProperties;->setMtu(I)V
...
.method public getTcpBufferSizesPropName()Ljava/lang/String;
    ...
    .line 457
    iget-object v4, p0, Landroid/net/MobileDataStateTracker;->mMSimPhoneService:Lcom/android/internal/telephony/msim/ITelephonyMSim;

    if-nez v4, :cond_0

    .line 458
    const-string v4, "Ignore TCP buffer size prop name request, return unknown!"
    ...
    invoke-interface {v4}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->getPreferredDataSubscription()I
    ...
    invoke-interface {v4, v0}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->getDataNetworkType(I)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
